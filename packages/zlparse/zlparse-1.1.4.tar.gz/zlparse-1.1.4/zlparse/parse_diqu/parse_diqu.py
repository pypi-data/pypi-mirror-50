...
class parseDiqu(object):
    ...
    def parse_diqu(self, quyu, page):
        ...
        :return: diqu_code
        """
        if  quyu.startswith('qg') or quyu.startswith('qycg') or quyu.endswith('quanguo') or quyu.startswith('zljianzhu') :
...
if __name__ == '__main__':
    ...
    # new_list_all = []
    # 
    # for quyu in total_list:
    #     p_diqu = parseDiqu(quyu, txtx)
    #     print(quyu, '======', p_diqu)
    #     print('------' * 3)
    # json_path = os.path.join(os.path.dirname(__file__), 'list.json')
    ...
    # for key,value in xzqh_key_word_dict_list.items():
    #     res = p.get_pinyin(value,'')
    #     xzqh_key_word_dict_list[key] = value+'_'+res
    # print(xzqh_key_word_dict_list)
