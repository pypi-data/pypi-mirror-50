...
revision = '0a44f662bd46'
down_revision = 'a26f133d42a9'
branch_labels = ()
depends_on = None
...
def upgrade():
    ...
    sa.ForeignKeyConstraint(['acl_id'], ['explicit_acls_propertyvalueacl.id'], name=op.f('fk_explicit_acls_propertyvalue_acl_id_explicit_acls_propertyvalueacl')),
    sa.ForeignKeyConstraint(['id'], ['explicit_acls_propertyvalue.id'], name=op.f('fk_explicit_acls_propertyvalue_id_explicit_acls_propertyvalue')),
