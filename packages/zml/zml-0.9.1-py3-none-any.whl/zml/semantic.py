...
RESOURCE = Suppress('@') + DESCRIPTOR('resource') + COLON + "'" + DESCRIPTOR('cid') + "'"
...
DATA_NODE_VALUE = Optional(EXPRESSION('expression') | INLINE_CONTENT('inline_content'))
...
INHERIT += FILENAME('documentfile')

IMPORT = Suppress('%') + Literal('import')('instruction')
IMPORT += FILENAME('documentfile')
