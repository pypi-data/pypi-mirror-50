...
class ApiClusterTemplateInstantiator(object):
    ...
    def __init__(self, cluster_name=None, hosts=None, variables=None, role_config_groups=None, cluster_spec=None, enable_kerberos=None, keep_host_templates=None):
        """
    ...
    def keep_host_templates(self):
        ...
        Keep the hosts templates from cluster template. Default is false i.e do not keep host templates
