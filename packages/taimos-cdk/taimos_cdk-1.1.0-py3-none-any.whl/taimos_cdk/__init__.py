...
import aws_cdk.core
__jsii_assembly__ = jsii.JSIIAssembly.load("taimos-cdk-constructs", "1.1.0", __name__, "taimos-cdk-constructs@1.1.0.jsii.tgz")
...
@jsii.data_type(jsii_type="taimos-cdk-constructs.SimpleCodeBuildConfig", jsii_struct_bases=[], name_mapping={'github_owner': 'githubOwner', 'github_repo': 'githubRepo', 'alert_email': 'alertEmail', 'branch': 'branch', 'github_secret_id': 'githubSecretId', 'use_build_spec_file': 'useBuildSpecFile'})
class SimpleCodeBuildConfig():
    def __init__(self, *, github_owner: str, github_repo: str, alert_email: typing.Optional[str]=None, branch: typing.Optional[str]=None, github_secret_id: typing.Optional[str]=None, use_build_spec_file: typing.Optional[bool]=None):
        """
        :param github_owner: -
        :param github_repo: -
        :param alert_email: -
...
class SimpleCodeBuildStack(aws_cdk.core.Stack, metaclass=jsii.JSIIMeta, jsii_type="taimos-cdk-constructs.SimpleCodeBuildStack"):
    def __init__(self, parent: aws_cdk.core.App, *, github_owner: str, github_repo: str, alert_email: typing.Optional[str]=None, branch: typing.Optional[str]=None, github_secret_id: typing.Optional[str]=None, use_build_spec_file: typing.Optional[bool]=None) -> None:
        """
        :param parent: -
        :param config: -
        :param github_owner: -
        ...
        :param use_build_spec_file: -
        """
        config = SimpleCodeBuildConfig(github_owner=github_owner, github_repo=github_repo, alert_email=alert_email, branch=branch, github_secret_id=github_secret_id, use_build_spec_file=use_build_spec_file)
...
__all__ = ["AlexaSkillConfig", "AlexaSkillDeploymentConfig", "AlexaSkillPipelineStack", "AlexaSkillStack", "ScheduledLambda", "ScheduledLambdaProps", "SimpleCodeBuildConfig", "SimpleCodeBuildStack", "SinglePageAppHosting", "SinglePageAppHostingProps", "__jsii_assembly__"]
