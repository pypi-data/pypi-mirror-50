...
class TrajectoryTrackerGains():
    ...
    Attributes:
        kd_along_track (float): Description
        kd_cross_track (float): Description
        kd_vel_along_track (float): Description
        kd_vel_cross_track (float): Description
        kd_vel_z (float): Description
        kd_yaw (float): Description
        kd_z_track (float): Description
        kp_along_track (float): Description
        kp_cross_track (float): Description
        kp_vel_along_track (float): Description
        kp_vel_cross_track (float): Description
        kp_vel_z (float): Description
        kp_yaw (float): Description
        kp_z_track (float): Description
    """
