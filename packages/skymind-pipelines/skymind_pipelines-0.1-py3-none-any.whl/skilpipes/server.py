from skilpipes.inference import InferenceConfiguration
import json
import subprocess
import os
from skilpipes.json_utils import json_with_type
...
class Server(object):
    ...
    def start(self):
        ...
        args.append('ai.skymind.modelserver.configprovider.ModelServerMain')
        args.append('--configPath')
        args.append(abs_path)
        args.append('--verticleClassName')
        args.append('ai.skymind.modelserver.verticles.inference.InferenceVerticle')
