...
from auquan_qq1_toolbox.problem2_execution_system import Problem2ExecutionSystem
try:
...
class MyTradingParams(TradingSystemParameters):
    ...
    def __init__(self, leagueFunctions):
        ...
        self.__dataSetId = 'QQ3P2Training'
    ...
    def getTimeRuleForUpdates(self):
        return CustomTimeRule(startDate=self.__startDate, endDate=self.__endDate, startTime='08:00', frequency='M', sample='1440')
    ...
    def getStartingCapital(self):
        return 3*10000*self.__playersInTeam
    ...
    def getInstrumentFeatureConfigDicts(self):
        ...
        predictionDict = {'featureKey': 'prediction',
                                ...
                                'params': {'leagueFunctions':self.__leagueFunctions,
                                            ...
                                            'playersInTeam': self.__playersInTeam}}
...
class TrainingPredictionFeature(Feature):
    ...
    def computeForInstrument(cls, updateNum, time, featureParams, featureKey, instrumentManager):
        ...
        playersInTeam = featureParams['playersInTeam']
        players = lf.getPlayersAndPosition(time, updateNum, lookbackInstrumentFeatures, lookbackMarketFeatures, targetVariable, playersInTeam)
