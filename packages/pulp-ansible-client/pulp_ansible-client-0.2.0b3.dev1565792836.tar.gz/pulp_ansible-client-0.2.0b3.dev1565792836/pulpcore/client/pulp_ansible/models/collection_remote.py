...
class CollectionRemote(object):
    ...
    def __init__(self, href=None, created=None, type=None, name=None, url=None, ssl_ca_certificate=None, ssl_client_certificate=None, ssl_client_key=None, ssl_validation=None, proxy_url=None, username=None, password=None, last_updated=None, download_concurrency=None, policy='immediate'):  # noqa: E501
