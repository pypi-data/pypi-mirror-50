...
setup(
  ...
  version = '0.1.post6',      # Start with a small number and increase it with every change you make
  license='MIT',
  ...
  download_url =
  'https://github.com/LocusAnalytics/peer-explorer/archive/v0.1.post6.tar.gz',
