...
setup(
    ...
    keywords='tendril',
    url='https://github.com/tendril-framework/tendril-validation',
    project_urls={
        'Documentation': 'https://tendril-validation.readthedocs.io/en/latest',
        'Bug Tracker': 'https://github.com/tendril-framework/tendril-validation/issues',
        'Source Repository': 'https://github.com/tendril-framework/tendril-validation',
    },
