...
class Icosahedron(BaseParticle):
    ...
    def __init__(self,
        ...
        prim = bulk(chemical_symbol, crystalstructure='fcc', a=lattice_parameter)
        prim, cubic_symmetries = get_primitive_with_symmetries(prim)
        ...
        for facet in self._yield_facets():
            facet.original_vertices = facet.vertices.copy()
    ...
    def atoms(self) -> Atoms:
        ...
        atoms = Atoms('{}{}'.format(self.primitive_structure[0].symbol,
                                    len(new_positions)),
