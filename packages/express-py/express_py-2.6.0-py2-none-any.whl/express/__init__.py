...
if __name__ == "__main__":
    ...
    work_dir = "/Users/exabyte/Downloads/vasp-neb-rxRpGZ3ETvfcWvAA9"
    stdout_file = "{}/vasp-neb.out".format(work_dir)
    exp = ExPrESS(parser, **dict({"work_dir": work_dir, "stdout_file": stdout_file}))
    # print(json.dumps(exp.property(property_name), indent=4))
    for s in exp.parser.initial_structure_strings(): print(s)
