...
_sage_const_3 = Integer(3); _sage_const_2 = Integer(2); _sage_const_1 = Integer(1); _sage_const_0 = Integer(0); _sage_const_7 = Integer(7); _sage_const_6 = Integer(6); _sage_const_5 = Integer(5); _sage_const_4 = Integer(4); _sage_const_9 = Integer(9); _sage_const_8 = Integer(8); _sage_const_29 = Integer(29); _sage_const_13 = Integer(13); _sage_const_12 = Integer(12); _sage_const_11 = Integer(11); _sage_const_10 = Integer(10); _sage_const_18 = Integer(18); _sage_const_15 = Integer(15); _sage_const_23 = Integer(23); _sage_const_21 = Integer(21); _sage_const_26 = Integer(26); _sage_const_50 = Integer(50)
import unittest
import itertools
...
class TestArithmeticMatroid(unittest.TestCase):
    ...
    def test_relizable(self):
        ...
        for a in xrange(_sage_const_6 ):
            for b in xrange(_sage_const_1 , _sage_const_6 ):
    ...
    def test_num_representations(self):
        ...
        for m in xrange(_sage_const_23 , _sage_const_26 ): # m(E)
            E = range(r)
...
class TestToric(unittest.TestCase):
    ...
    def test_poset_of_layers_root_system_C2(self):
        ...
        self.assertEqual([homology[i].ngens() for i in xrange(_sage_const_2 )], [_sage_const_0 ,_sage_const_3 ])
    ...
    def test_poset_of_layers_root_system_C3(self):
        ...
        P = M.poset_of_layers()
        homology = P.subposet([a for a in P if a != P.bottom()]).order_complex(on_ints=True).homology()
        self.assertEqual([homology[i].ngens() for i in xrange(_sage_const_3 )], [_sage_const_0 ,_sage_const_0 ,_sage_const_15 ])
    ...
    def test_poset_of_layers_root_system_B2(self):
        ...
        P = M.poset_of_layers()
        homology = P.subposet([a for a in P if a != P.bottom()]).order_complex(on_ints=True).homology()
        self.assertEqual([homology[i].ngens() for i in xrange(_sage_const_2 )], [_sage_const_0 ,_sage_const_1 ])
        self.assertEqual(homology[_sage_const_1 ].ngens(), M.arithmetic_tutte_polynomial()(x=_sage_const_0 , y=_sage_const_0 ))
    ...
    def test_poset_of_layers_root_system_B3(self):
        ...
        P = M.poset_of_layers()
        homology = P.subposet([a for a in P if a != P.bottom()]).order_complex(on_ints=True).homology()
        self.assertEqual([homology[i].ngens() for i in xrange(_sage_const_3 )], [_sage_const_0 ,_sage_const_0 ,_sage_const_6 ])
        self.assertEqual(homology[_sage_const_2 ].ngens(), M.arithmetic_tutte_polynomial()(x=_sage_const_0 , y=_sage_const_0 ))
    ...
    def test_poset_of_layers_root_system_D3(self):
        ...
        P = M.poset_of_layers()
        homology = P.subposet([a for a in P if a != P.bottom()]).order_complex(on_ints=True).homology()
        self.assertEqual([homology[i].ngens() for i in xrange(_sage_const_3 )], [_sage_const_0 ,_sage_const_0 ,_sage_const_3 ])
        self.assertEqual(homology[_sage_const_2 ].ngens(), M.arithmetic_tutte_polynomial()(x=_sage_const_0 , y=_sage_const_0 ))
    ...
    def test_different_posets_of_layers(self):
        ...
        C = matrix(ZZ, [[_sage_const_1 ,_sage_const_2 ,_sage_const_2 ,_sage_const_1 ], [_sage_const_0 ,_sage_const_5 ,_sage_const_0 ,_sage_const_5 ], [_sage_const_0 ,_sage_const_0 ,_sage_const_5 ,-_sage_const_5 ]])  # new matrix
...
class TestNormalForm(unittest.TestCase):
    ...
    def test_1x1(self):
        for x in xrange(-_sage_const_5 , _sage_const_5 ):
            A = matrix(ZZ, [[x]])
    ...
    def test_2x2(self):
        ...
        self.assertEqual(normal_form(A), matrix(ZZ, [[_sage_const_5 , _sage_const_1 ], [_sage_const_0 , _sage_const_3 ]]))
    ...
    def random_test(self, r, n, all=False):
        ...
        if all:
            ...
            S = diagonal_matrix([sage.misc.prandom.choice([_sage_const_1 , -_sage_const_1 ]) for i in xrange(n)])
            self.assertEqual(normal_form(A), normal_form(U*A*S))
    ...
    def test_is_in_hermite_form(self):
        ...
        for i in xrange(_sage_const_10 ):
