        ...
        for field in self.__pdc_field_handling_order__:
            ...
            if field.name in self.__pdc_field_handlers__:
                ...
                if field_value is None:
                    # checking for _MISSING_TYPE is discouraged by docs, but this lib does not provide a method
                    # to determine whether a field has a default. ᕕ( ᐛ )ᕗ
                    field_has_default = type(field.default) is not dataclasses._MISSING_TYPE or type(
