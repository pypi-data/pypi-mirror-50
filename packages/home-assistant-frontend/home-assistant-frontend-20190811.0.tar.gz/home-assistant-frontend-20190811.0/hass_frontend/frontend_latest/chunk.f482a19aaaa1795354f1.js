/*! For license information please see chunk.f482a19aaaa1795354f1.js.LICENSE */
...
</dom-module>`;a.setAttribute("style","display: none;"),document.head.appendChild(a.content)},207:function(e,t,r){"use strict";r.d(t,"b",function(){return a}),r.d(t,"a",function(){return i});const a=(e,t)=>e<t?-1:e>t?1:0,i=(e,t)=>a(e.toLowerCase(),t.toLowerCase())},229:function(e,t,r){"use strict";r(4),r(44),r(107),r(203),r(55),r(41);var a=r(53),i=r(34),o=r(67);const n={properties:{elevation:{type:Number,reflectToAttribute:!0,readOnly:!0}},observers:["_calculateElevation(focused, disabled, active, pressed, receivedFocusFromKeyboard)","_computeKeyboardClass(receivedFocusFromKeyboard)"],hostAttributes:{role:"button",tabindex:"0",animated:!0},_calculateElevation:function(){var e=1;this.disabled?e=0:this.active||this.pressed?e=4:this.receivedFocusFromKeyboard&&(e=3),this._setElevation(e)},_computeKeyboardClass:function(e){this.toggleClass("keyboard-focus",e)},_spaceKeyDownHandler:function(e){a.b._spaceKeyDownHandler.call(this,e),this.hasRipple()&&this.getRipple().ripples.length<1&&this._ripple.uiDownAction()},_spaceKeyUpHandler:function(e){a.b._spaceKeyUpHandler.call(this,e),this.hasRipple()&&this._ripple.uiUpAction()}},s=[a.a,i.a,o.a,n];var p=r(5);const l=r(3).a`
...
`;l.setAttribute("strip-whitespace",""),Object(p.a)({_template:l,is:"paper-fab",behaviors:[s],properties:{src:{type:String,value:""},icon:{type:String,value:""},mini:{type:Boolean,value:!1,reflectToAttribute:!0},label:{type:String,observer:"_labelChanged"}},_labelChanged:function(){this.setAttribute("aria-label",this.label)},_computeIsIconFab:function(e,t){return e.length>0||t.length>0}})},329:function(e,t,r){"use strict";r.d(t,"a",function(){return a}),r.d(t,"b",function(){return i}),r.d(t,"d",function(){return o}),r.d(t,"e",function(){return n}),r.d(t,"c",function(){return s});const a="system-admin",i="system-users",o=async e=>e.callWS({type:"config/auth/list"}),n=async(e,t,r)=>e.callWS(Object.assign({},r,{type:"config/auth/update",user_id:t})),s=async(e,t)=>e.callWS({type:"config/auth/delete",user_id:t})},727:function(e,t,r){"use strict";r.r(t);var a=r(0);r(138),r(177),r(229);const i=e=>e.callWS({type:"person/list"}),o=(e,t)=>e.callWS(Object.assign({type:"person/create"},t)),n=(e,t,r)=>e.callWS(Object.assign({type:"person/update",person_id:t},r)),s=(e,t)=>e.callWS({type:"person/delete",person_id:t});r(171),r(147),r(153);var p=r(207),l=(r(189),r(19));const c=()=>Promise.all([r.e(0),r.e(1),r.e(3),r.e(2),r.e(104)]).then(r.bind(null,723)),d=(e,t)=>{Object(l.a)(e,"show-dialog",{dialogTag:"dialog-person-detail",dialogImport:c,dialogParams:t})};var h=r(329);customElements.define("ha-config-person",class extends a.a{constructor(...e){super(...e),this.hass=void 0,this.isWide=void 0,this._storageItems=void 0,this._configItems=void 0,this._usersLoad=void 0}static get properties(){return{hass:{},isWide:{},_storageItems:{},_configItems:{}}}render(){return this.hass&&void 0!==this._storageItems&&void 0!==this._configItems?a.f`
    ...
    `}})}}]);
//# sourceMappingURL=chunk.f482a19aaaa1795354f1.js.map