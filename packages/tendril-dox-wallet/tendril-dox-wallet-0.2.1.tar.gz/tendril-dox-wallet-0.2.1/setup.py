...
setup(
    ...
    keywords='tendril',
    url='https://github.com/tendril-framework/tendril-dox-wallet',
    project_urls={
        'Documentation': 'https://tendril-dox-wallet.readthedocs.io/en/latest',
        'Bug Tracker': 'https://github.com/tendril-dox-wallet/tendril-schema/issues',
        'Source Repository': 'https://github.com/tendril-framework/tendril-dox-wallet',
    },
