...
class db:
    ...
    def db_etl(self, sql, datadict, dbtypes, tb_name, size='100000,10000', conp1=None, conp2=None, pool='0,1'):
        ...
        print(dbtypes)
        con1 = create_engine("%s://%s:%s@%s/%s" % (dbtypes[0], conp1[0], conp1[1], conp1[2], conp1[3]),
                             encoding='utf-8')
        con2 = create_engine("%s://%s:%s@%s/%s" % (dbtypes[1], conp2[0], conp2[1], conp2[2], conp2[3]),
                             encoding='utf-8')
    ...
    def db_etl_byname(self, tb_name, dbtypes, tb_name_target=None, size='100000,10000', conp1=None, conp2=None,
                      pool='0,1'):
