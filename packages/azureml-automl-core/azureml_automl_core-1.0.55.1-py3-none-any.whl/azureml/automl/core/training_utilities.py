...
def init_dataset(
    ...
    """
    if automl_settings.use_incremental_learning:
        return init_streaming_dataset(transformed_data_context=transformed_data_context)
...
def init_streaming_dataset(transformed_data_context: TransformedDataContext) -> StreamingDataset:
    """
