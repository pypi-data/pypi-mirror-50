...
class ClientDatasets(DatasetBase):
    ...
    TRAIN_CV_SPLITS = 'train_CV_splits'
    FEATURIZED_TRAIN_CV_SPLITS = 'featurized_train_CV_splits'
    FEATURIZED_TRAIN = 'featurized_train'
    FEATURIZED_TEST = 'featurized_test'
    FEATURIZED_VALID = 'featurized_valid'
    TRAIN = 'train_indices'
    TEST = 'test_indices'
    VALID = 'valid_indices'
