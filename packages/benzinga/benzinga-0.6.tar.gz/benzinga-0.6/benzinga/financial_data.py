...
class Benzinga: 
    ...
    def dividends(self, page=None, pagesize=None, date_asof=None, date_from=None, date_to=None,
        ...
        try:
            ...
            raise AccessDeniedError
        result_out = dividends.json() if importance == None else self.__importance("dividends", dividends.json(), importance)
        return result_out
    ...
    def ratings(self, page=None, pagesize=None, date_asof=None, date_from=None, date_to=None,
        ...
        try:
            ...
            raise AccessDeniedError
        result_out = ratings.json() if importance == None else self.__importance("ratings", ratings.json(), importance)
        return result_out
