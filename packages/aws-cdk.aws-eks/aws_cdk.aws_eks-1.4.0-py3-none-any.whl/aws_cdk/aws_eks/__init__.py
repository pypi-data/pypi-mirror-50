...
import aws_cdk.core
__jsii_assembly__ = jsii.JSIIAssembly.load("@aws-cdk/aws-eks", "1.4.0", __name__, "aws-eks@1.4.0.jsii.tgz")
@jsii.data_type(jsii_type="@aws-cdk/aws-eks.AutoScalingGroupOptions", jsii_struct_bases=[], name_mapping={'max_pods': 'maxPods', 'map_role': 'mapRole'})
class AutoScalingGroupOptions():
    def __init__(self, *, max_pods: jsii.Number, map_role: typing.Optional[bool]=None):
...
class Cluster(aws_cdk.core.Resource, metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-eks.Cluster"):
    ...
    def __init__(self, scope: aws_cdk.core.Construct, id: str, *, cluster_name: typing.Optional[str]=None, default_capacity: typing.Optional[jsii.Number]=None, default_capacity_instance: typing.Optional[aws_cdk.aws_ec2.InstanceType]=None, kubectl_enabled: typing.Optional[bool]=None, masters_role: typing.Optional[aws_cdk.aws_iam.IRole]=None, role: typing.Optional[aws_cdk.aws_iam.IRole]=None, security_group: typing.Optional[aws_cdk.aws_ec2.ISecurityGroup]=None, version: typing.Optional[str]=None, vpc: typing.Optional[aws_cdk.aws_ec2.IVpc]=None, vpc_subnets: typing.Optional[typing.List[aws_cdk.aws_ec2.SubnetSelection]]=None) -> None:
        ...
        :stability: experimental
        """
        props = ClusterProps(cluster_name=cluster_name, default_capacity=default_capacity, default_capacity_instance=default_capacity_instance, kubectl_enabled=kubectl_enabled, masters_role=masters_role, role=role, security_group=security_group, version=version, vpc=vpc, vpc_subnets=vpc_subnets)
    ...
    def add_auto_scaling_group(self, auto_scaling_group: aws_cdk.aws_autoscaling.AutoScalingGroup, *, max_pods: jsii.Number, map_role: typing.Optional[bool]=None) -> None:
...
__all__ = ["AutoScalingGroupOptions", "AwsAuth", "AwsAuthProps", "CapacityOptions", "CfnCluster", "CfnClusterProps", "Cluster", "ClusterAttributes", "ClusterProps", "EksOptimizedAmi", "EksOptimizedAmiProps", "ICluster", "KubernetesResource", "KubernetesResourceProps", "Mapping", "NodeType", "__jsii_assembly__"]
