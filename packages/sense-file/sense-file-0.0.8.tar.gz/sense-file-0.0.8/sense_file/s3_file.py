...
class S3File(object):
    ...
    def download(self, file_name, aim_path, bucket_name):
        ...
        try:
            ...
            log_error(
                'file {} down from s3 {} error,msg: {}'.format(file_name, bucket_name, e.__str__()))
...
if __name__ == '__main__':
    s3_file = S3File('aws')
    _path = '/Users/liuguangbin/Documents/alg/conf/news_sentiment_v2019081215.ini'
    print(s3_file.upload_model('alg_access_config/news_sentiment_v2019081215.ini', _path, 'sdai-conf', 'conf'))
