...
<xsl:stylesheet
    ...
    <xsl:template match="article">
        <doi_batch xsi:schemaLocation="http://www.crossref.org/schema/4.4.2 http://www.crossref.org/schemas/crossref4.4.2.xsd" version="4.4.2">
            <xsl:copy-of select="converter:head(.)"/>
            <body>
                <journal>
                    <journal_metadata>
                        <full_title><xsl:value-of select="front/journal-meta/journal-title-group/journal-title"/></full_title>
                    ...
                    <journal_article publication_type="full_text" reference_distribution_opts="any">
                        ...
                        <xsl:apply-templates select="front/article-meta/pub-date[@publication-format='epub' and @date-type='pub']" mode="electronic"/>
