...
setup(
    ...
    keywords='tendril',
    url='https://github.com/tendril-framework/tendril-utils-vcs',
    project_urls={
        'Documentation': 'https://tendril-utils-vcs.readthedocs.io/en/latest',
        'Bug Tracker': 'https://github.com/tendril-framework/tendril-utils-vcs/issues',
        'Source Repository': 'https://github.com/tendril-framework/tendril-utils-vcs',
    },
