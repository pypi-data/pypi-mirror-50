...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_Protocole_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_Protocole_t qt_meta_stringdata_Protocole = {
    {
QT_MOC_LITERAL(0, 0, 9), // "Protocole"
...
void Protocole::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (Protocole::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Protocole::messageReceived)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject Protocole::staticMetaObject = { {
    &QObject::staticMetaObject,
    qt_meta_stringdata_Protocole.data,
    qt_meta_data_Protocole,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *Protocole::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_Protocole.stringdata0))
