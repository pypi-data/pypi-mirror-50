...
from tutti_aisthetics.utils import losses
...
class Nima:
    ...
    def __init__(self, base_model_name, n_classes=10, learning_rate=0.001, dropout_rate=0,
                 loss=losses.earth_movers_distance, decay=0, weights='imagenet'):
        """
    ...
    def build(self):
        """ Model builder method: gets the base CNN and adds a dropout layer and a dense layer on top """
