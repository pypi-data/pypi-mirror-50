...
def prediction_summary(model: model_builder.Nima, image_source: str, predictions_file: str = None,
    ...
    data_generator = data_generator.TestDataGenerator(samples, image_dir, 64, 10, model.preprocessing_function(),
    ...
    log.debug('Response = {}'.format(json.dumps(samples, indent=2)))
