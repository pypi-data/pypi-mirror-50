...
def hand_userid():
    if 'hand_userid' in session:
        return session.get('hand_userid')
    else:
        return 'please use accesstoken login'

def hand_username():
    if 'hand_username' in session:
        return session.get('hand_username')
        return g.user.username
...
def hand_fstname():
    if 'hand_fstname' in session:
        return session.get('hand_fstname')
    else:
        return 'please use accesstoken login'

def hand_posid():
    if 'hand_posid' in session:
        return session.get('hand_posid')
    else:
        return 'please use accesstoken login'

def hand_posname():
    if 'hand_posname' in session:
        return session.get('hand_posname')
    else:
        return 'please use accesstoken login'

def hand_orgid():
    if 'hand_orgid' in session:
        return session.get('hand_orgid')
    else:
        return 'please use accesstoken login'

def hand_orgname():
    if 'hand_orgname' in session:
        return session.get('hand_orgname')
    else:
        return 'please use accesstoken login'

def hand_attr01():
    if 'hand_attr01' in session:
        return session.get('hand_attr01')
    else:
        return 'please use accesstoken login'

def hand_attr02():
    if 'hand_attr02' in session:
        return session.get('hand_attr02')
    else:
        return 'please use accesstoken login'

def hand_attr03():
    if 'hand_attr03' in session:
        return session.get('hand_attr03')
    else:
        return 'please use accesstoken login'

def hand_attr04():
    if 'hand_attr04' in session:
        return session.get('hand_attr04')
    else:
        return 'please use accesstoken login'

def hand_attr05():
    if 'hand_attr05' in session:
        return session.get('hand_attr05')
    else:
        return 'please use accesstoken login'
    ...
    def __init__(
        ...
        **kwargs
        ...
        self.context = {
            ...
            "form_data": {},
            'hand_userid': hand_userid,
            'hand_username': hand_username,
            'hand_fstname': hand_fstname,
            'hand_posid': hand_posid,
            'hand_posname': hand_posname,
            'hand_orgid': hand_orgid,
            'hand_orgname': hand_orgname,
            'hand_attr01': hand_attr01,
            'hand_attr02': hand_attr02,
            'hand_attr03': hand_attr03,
            'hand_attr04': hand_attr04,
            'hand_attr05': hand_attr05,
        }
