...
setup(
    ...
    keywords='tendril',
    url='https://github.com/tendril-framework/tendril-utils-yaml',
    project_urls={
        'Documentation': 'https://tendril-utils-yaml.readthedocs.io/en/latest',
        'Bug Tracker': 'https://github.com/tendril-framework/tendril-utils-yaml/issues',
        'Source Repository': 'https://github.com/tendril-framework/tendril-utils-yaml',
    },
