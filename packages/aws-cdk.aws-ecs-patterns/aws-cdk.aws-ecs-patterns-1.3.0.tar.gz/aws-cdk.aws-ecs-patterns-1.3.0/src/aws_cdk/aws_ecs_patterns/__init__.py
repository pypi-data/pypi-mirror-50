...
import aws_cdk.core
__jsii_assembly__ = jsii.JSIIAssembly.load("@aws-cdk/aws-ecs-patterns", "1.3.0", __name__, "aws-ecs-patterns@1.3.0.jsii.tgz")
class LoadBalancedServiceBase(aws_cdk.core.Construct, metaclass=jsii.JSIIAbstractClass, jsii_type="@aws-cdk/aws-ecs-patterns.LoadBalancedServiceBase"):
    ...
    def __init__(self, scope: aws_cdk.core.Construct, id: str, *, image: aws_cdk.aws_ecs.ContainerImage, certificate: typing.Optional[aws_cdk.aws_certificatemanager.ICertificate]=None, cluster: typing.Optional[aws_cdk.aws_ecs.ICluster]=None, container_name: typing.Optional[str]=None, container_port: typing.Optional[jsii.Number]=None, desired_count: typing.Optional[jsii.Number]=None, domain_name: typing.Optional[str]=None, domain_zone: typing.Optional[aws_cdk.aws_route53.IHostedZone]=None, enable_logging: typing.Optional[bool]=None, environment: typing.Optional[typing.Mapping[str,str]]=None, execution_role: typing.Optional[aws_cdk.aws_iam.IRole]=None, load_balancer_type: typing.Optional["LoadBalancerType"]=None, public_load_balancer: typing.Optional[bool]=None, public_tasks: typing.Optional[bool]=None, secrets: typing.Optional[typing.Mapping[str,aws_cdk.aws_ecs.Secret]]=None, service_name: typing.Optional[str]=None, task_role: typing.Optional[aws_cdk.aws_iam.IRole]=None, vpc: typing.Optional[aws_cdk.aws_ec2.IVpc]=None) -> None:
        ...
        :param cluster: The cluster where your service will be deployed You can only specify either vpc or cluster. Alternatively, you can leave both blank Default: - create a new cluster; if you do not specify a cluster nor a vpc, a new VPC will be created for you as well
        ...
        :param secrets: Secret environment variables to pass to the container. Default: - No secret environment variables.
...
class LoadBalancedServiceBaseProps():
    ...
    def cluster(self) -> typing.Optional[aws_cdk.aws_ecs.ICluster]:
        """The cluster where your service will be deployed You can only specify either vpc or cluster.

        Alternatively, you can leave both blank
    ...
    def vpc(self) -> typing.Optional[aws_cdk.aws_ec2.IVpc]:
        """VPC that the cluster instances or tasks are running in You can only specify either vpc or cluster.
...
class QueueProcessingServiceBase(aws_cdk.core.Construct, metaclass=jsii.JSIIAbstractClass, jsii_type="@aws-cdk/aws-ecs-patterns.QueueProcessingServiceBase"):
    ...
    def __init__(self, scope: aws_cdk.core.Construct, id: str, *, cluster: aws_cdk.aws_ecs.ICluster, image: aws_cdk.aws_ecs.ContainerImage, command: typing.Optional[typing.List[str]]=None, desired_task_count: typing.Optional[jsii.Number]=None, enable_logging: typing.Optional[bool]=None, environment: typing.Optional[typing.Mapping[str,str]]=None, max_scaling_capacity: typing.Optional[jsii.Number]=None, queue: typing.Optional[aws_cdk.aws_sqs.IQueue]=None, scaling_steps: typing.Optional[typing.List[aws_cdk.aws_applicationautoscaling.ScalingInterval]]=None, secrets: typing.Optional[typing.Mapping[str,aws_cdk.aws_ecs.Secret]]=None) -> None:
        ...
        :param image: The image used to start a container. This string is passed directly to the Docker daemon. Images in the Docker Hub registry are available by default. Other repositories are specified with either repository-url/image:tag or repository-url/image@digest.
        ...
        :stability: experimental
        """
        props = QueueProcessingServiceBaseProps(cluster=cluster, image=image, command=command, desired_task_count=desired_task_count, enable_logging=enable_logging, environment=environment, max_scaling_capacity=max_scaling_capacity, queue=queue, scaling_steps=scaling_steps, secrets=secrets)
...
class QueueProcessingFargateService(QueueProcessingServiceBase, metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-ecs-patterns.QueueProcessingFargateService"):
    ...
    def __init__(self, scope: aws_cdk.core.Construct, id: str, *, cpu: typing.Optional[jsii.Number]=None, memory_limit_mib: typing.Optional[jsii.Number]=None, cluster: aws_cdk.aws_ecs.ICluster, image: aws_cdk.aws_ecs.ContainerImage, command: typing.Optional[typing.List[str]]=None, desired_task_count: typing.Optional[jsii.Number]=None, enable_logging: typing.Optional[bool]=None, environment: typing.Optional[typing.Mapping[str,str]]=None, max_scaling_capacity: typing.Optional[jsii.Number]=None, queue: typing.Optional[aws_cdk.aws_sqs.IQueue]=None, scaling_steps: typing.Optional[typing.List[aws_cdk.aws_applicationautoscaling.ScalingInterval]]=None, secrets: typing.Optional[typing.Mapping[str,aws_cdk.aws_ecs.Secret]]=None) -> None:
        ...
        :stability: experimental
        """
        props = QueueProcessingFargateServiceProps(cpu=cpu, memory_limit_mib=memory_limit_mib, cluster=cluster, image=image, command=command, desired_task_count=desired_task_count, enable_logging=enable_logging, environment=environment, max_scaling_capacity=max_scaling_capacity, queue=queue, scaling_steps=scaling_steps, secrets=secrets)
...
@jsii.data_type(jsii_type="@aws-cdk/aws-ecs-patterns.QueueProcessingFargateServiceProps", jsii_struct_bases=[QueueProcessingServiceBaseProps], name_mapping={'cluster': 'cluster', 'image': 'image', 'command': 'command', 'desired_task_count': 'desiredTaskCount', 'enable_logging': 'enableLogging', 'environment': 'environment', 'max_scaling_capacity': 'maxScalingCapacity', 'queue': 'queue', 'scaling_steps': 'scalingSteps', 'secrets': 'secrets', 'cpu': 'cpu', 'memory_limit_mib': 'memoryLimitMiB'})
...
class ScheduledTaskBase(aws_cdk.core.Construct, metaclass=jsii.JSIIAbstractClass, jsii_type="@aws-cdk/aws-ecs-patterns.ScheduledTaskBase"):
    ...
    def __init__(self, scope: aws_cdk.core.Construct, id: str, *, cluster: aws_cdk.aws_ecs.ICluster, image: aws_cdk.aws_ecs.ContainerImage, schedule: aws_cdk.aws_applicationautoscaling.Schedule, command: typing.Optional[typing.List[str]]=None, desired_task_count: typing.Optional[jsii.Number]=None, environment: typing.Optional[typing.Mapping[str,str]]=None, secrets: typing.Optional[typing.Mapping[str,aws_cdk.aws_ecs.Secret]]=None) -> None:
        ...
        :stability: experimental
        """
        props = ScheduledTaskBaseProps(cluster=cluster, image=image, schedule=schedule, command=command, desired_task_count=desired_task_count, environment=environment, secrets=secrets)
...
class ScheduledEc2Task(ScheduledTaskBase, metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-ecs-patterns.ScheduledEc2Task"):
    ...
    def __init__(self, scope: aws_cdk.core.Construct, id: str, *, cpu: typing.Optional[jsii.Number]=None, memory_limit_mib: typing.Optional[jsii.Number]=None, memory_reservation_mib: typing.Optional[jsii.Number]=None, cluster: aws_cdk.aws_ecs.ICluster, image: aws_cdk.aws_ecs.ContainerImage, schedule: aws_cdk.aws_applicationautoscaling.Schedule, command: typing.Optional[typing.List[str]]=None, desired_task_count: typing.Optional[jsii.Number]=None, environment: typing.Optional[typing.Mapping[str,str]]=None, secrets: typing.Optional[typing.Mapping[str,aws_cdk.aws_ecs.Secret]]=None) -> None:
        ...
        :stability: experimental
        """
        props = ScheduledEc2TaskProps(cpu=cpu, memory_limit_mib=memory_limit_mib, memory_reservation_mib=memory_reservation_mib, cluster=cluster, image=image, schedule=schedule, command=command, desired_task_count=desired_task_count, environment=environment, secrets=secrets)
...
class ScheduledFargateTask(ScheduledTaskBase, metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-ecs-patterns.ScheduledFargateTask"):
    ...
    def __init__(self, scope: aws_cdk.core.Construct, id: str, *, cpu: typing.Optional[jsii.Number]=None, memory_limit_mib: typing.Optional[jsii.Number]=None, cluster: aws_cdk.aws_ecs.ICluster, image: aws_cdk.aws_ecs.ContainerImage, schedule: aws_cdk.aws_applicationautoscaling.Schedule, command: typing.Optional[typing.List[str]]=None, desired_task_count: typing.Optional[jsii.Number]=None, environment: typing.Optional[typing.Mapping[str,str]]=None, secrets: typing.Optional[typing.Mapping[str,aws_cdk.aws_ecs.Secret]]=None) -> None:
        ...
        :stability: experimental
        """
        props = ScheduledFargateTaskProps(cpu=cpu, memory_limit_mib=memory_limit_mib, cluster=cluster, image=image, schedule=schedule, command=command, desired_task_count=desired_task_count, environment=environment, secrets=secrets)
...
@jsii.data_type(jsii_type="@aws-cdk/aws-ecs-patterns.ScheduledTaskBaseProps", jsii_struct_bases=[], name_mapping={'cluster': 'cluster', 'image': 'image', 'schedule': 'schedule', 'command': 'command', 'desired_task_count': 'desiredTaskCount', 'environment': 'environment', 'secrets': 'secrets'})
...
@jsii.data_type(jsii_type="@aws-cdk/aws-ecs-patterns.ScheduledFargateTaskProps", jsii_struct_bases=[ScheduledTaskBaseProps], name_mapping={'cluster': 'cluster', 'image': 'image', 'schedule': 'schedule', 'command': 'command', 'desired_task_count': 'desiredTaskCount', 'environment': 'environment', 'secrets': 'secrets', 'cpu': 'cpu', 'memory_limit_mib': 'memoryLimitMiB'})
