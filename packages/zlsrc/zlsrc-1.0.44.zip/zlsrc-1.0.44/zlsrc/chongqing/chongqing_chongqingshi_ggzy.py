...
def f1(driver, num):
    ...
    for c in cons:
        ...
        href='/'.join(['https://www.cqggzy.com/xxhz',categorynum[:6],categorynum[:9],categorynum,ggstart_time.replace('-',''),href+'.html'])
...
if __name__ == '__main__':
    ...
    work(conp=conp,num=1,total=2,headless=True,long_ip=False)
