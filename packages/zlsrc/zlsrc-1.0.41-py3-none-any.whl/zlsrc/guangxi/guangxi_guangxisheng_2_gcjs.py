...
def f1(driver, num):
    ...
    for content in content_list:
        ...
        href = 'http://jtt.gxzf.gov.cn/zwgk/zfxxgk/ggzyjy' + content.xpath('./span[last()]/a/@href')[0].strip(' .')
...
def f3(driver, url):
    driver.get(url)
    locator = (By.XPATH, '//div[@class="contentS"]')
...
data = [
    ["gcjs_zhongbiao_gg",
     "http://jtt.gxzf.gov.cn/zwgk/zfxxgk/ggzyjy/index_1.html",
