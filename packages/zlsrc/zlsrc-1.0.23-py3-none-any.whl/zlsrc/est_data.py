...
def get_quyu_dict_diqu():
    ...
    dir_delete_list = ['zlshenpi', 'zljianzhu', 'zlcommon','zlsys', 'lib', 'util']
...
def get_quyu_dict_zlsys():
    dir = os.path.dirname(__file__)
    zlcommon_dir = os.path.join(dir, 'zlsys')
    file_list = os.listdir(zlcommon_dir)
    quyu_dict=OrderedDict()
...
def get_quyu_dict_zljianzhu():
    ...
    quyu_dict=OrderedDict()
    fileList=['zljianzhu_gg','zljianzhu_qiyexx','zljianzhu_renyuanxx','zljianzhu_xiangmuxx']
