...
ci_total_injections = []
ci_total_injections.append("")
ci_total_injections.append(1)  # Index 1
ci_total_injections.append(2)  # Index 2
ci_total_injections.append(3)  # Index 3

ci_total_injections = ci_total_injections[batch_id]
...
ci_data_path = af.path_util.make_and_return_path_from_path_and_folder_names(
    path=cosma_path,
    folder_names=["data", ci_data_type, ci_data_model, ci_data_resolution, 'total_injections_' + str(ci_total_injections)],
)
...
ci_regions = tools.parallel_and_serial_ci_regions_from_ci_data_resolution(total_injections=ci_total_injections)
...
pipeline_init = parallel_x2_serial_x3.make_pipeline(
    phase_folders=[ci_data_type, ci_data_model, ci_data_resolution, 'total_injections_' + str(ci_total_injections)],
...
pipeline_hyper = parallel_x2_serial_x3.make_pipeline(
    phase_folders=[ci_data_type, ci_data_model, ci_data_resolution, 'total_injections_' + str(ci_total_injections)],
    mask_function=mask_function_for_bug,
    cosmic_ray_parallel_buffer=10,
    cosmic_ray_serial_buffer=10,
