...
from tlclient.trader.constant import (MODULE_ERR_MSG_LENGTH, MODULE_ORDERREF_LENGTH, MODULE_TICKER_LENGTH, 
                             MODULE_SOURCE_LENGTH, MODULE_TRADEID_LENGTH, MODULE_TRADINGDAY_LENGTH)
from tlclient.trader.constant import Direction, ExchangeID, OrderStatus, OrderType, PosiDirection, OffsetFlag, AssetType, MarginMode
...
class PositionInfo:
    ...
    def __str__(self):
        return '<pi ex={} ticker={} source={} dir={} pos={} ydpos={} cost={}>'.format(
            ExchangeID.read(self.exchange), self.ticker, self.source, PosiDirection.read(self.posi_direction), 
            self.position, self.yd_position, self.position_cost
        )
