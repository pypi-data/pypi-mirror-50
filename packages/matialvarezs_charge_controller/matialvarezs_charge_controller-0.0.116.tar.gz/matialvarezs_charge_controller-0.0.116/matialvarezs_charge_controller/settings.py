...
SERVER_PROTOCOL = getattr(settings, APP + 'CENTRAL_SERVER_PROTOCOL')
IP_CENTRAL_SERVER = getattr(settings, APP + 'CENTRAL_SERVER_IP')
SERVER_API_PORT = getattr(settings, APP + 'CENTRAL_SERVER_API_PORT')
