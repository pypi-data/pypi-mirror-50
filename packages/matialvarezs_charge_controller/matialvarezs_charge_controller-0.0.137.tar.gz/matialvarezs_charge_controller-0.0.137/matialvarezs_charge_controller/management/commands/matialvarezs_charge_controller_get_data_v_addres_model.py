...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        try:
            ...
            res = matialvarezs_request_handler_utils.send_post_and_get_response(headers=settings.SISNBYTED_REQUEST_HEADERS,url=settings.MATIALVAREZS_CHARGE_CONTROLLER_CREATE_DATA_CHARGE_CONTROLLER_URL, data=data)
