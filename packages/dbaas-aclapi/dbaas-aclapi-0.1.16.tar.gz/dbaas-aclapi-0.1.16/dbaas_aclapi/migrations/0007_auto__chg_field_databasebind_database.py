...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'DatabaseBind.database'
        db.alter_column(u'dbaas_aclapi_databasebind', 'database_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.SET_NULL, to=orm['logical.Database']))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'DatabaseBind.database'
        raise RuntimeError("Cannot reverse this migration. 'DatabaseBind.database' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'DatabaseBind.database'
        db.alter_column(u'dbaas_aclapi_databasebind', 'database_id', self.gf('django.db.models.fields.related.ForeignKey')(on_delete=models.PROTECT, to=orm['logical.Database']))
