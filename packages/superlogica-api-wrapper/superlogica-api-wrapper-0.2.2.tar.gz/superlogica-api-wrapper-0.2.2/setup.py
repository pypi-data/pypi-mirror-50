...
setup(
    name='superlogica-api-wrapper',
    version=get_version(package),
    description='superlogica API wrapper using tapioca',
    long_description=readme,
    author=get_author(package),
    author_email=get_email(package),
    url='https://github.com/gupy-io/superlogica-api-wrapper',
    packages=[
        'superlogica',
    ],
    package_dir={'superlogica': 'superlogica'},
    include_package_data=True,
    install_requires=requirements,
    license="MIT",
    zip_safe=False,
    keywords='superlogica',
    classifiers=[
