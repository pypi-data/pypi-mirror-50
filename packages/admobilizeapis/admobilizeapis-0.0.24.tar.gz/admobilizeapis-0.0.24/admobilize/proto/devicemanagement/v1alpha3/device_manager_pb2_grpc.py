...
class DeviceManagerStub(object):
  ...
  def __init__(self, channel):
    ...
    self.CreateDevice = channel.unary_unary(
        ...
        request_serializer=admobilize_dot_devicemanagement_dot_v1alpha3_dot_resources__pb2.Device.SerializeToString,
...
def add_DeviceManagerServicer_to_server(servicer, server):
  rpc_method_handlers = {
      'CreateDevice': grpc.unary_unary_rpc_method_handler(
          ...
          request_deserializer=admobilize_dot_devicemanagement_dot_v1alpha3_dot_resources__pb2.Device.FromString,
