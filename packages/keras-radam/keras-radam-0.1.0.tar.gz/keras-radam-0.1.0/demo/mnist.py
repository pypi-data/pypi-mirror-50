...
radam_score = radam_model.evaluate(x_test, y_test)
print('Score of RAdam:\t%.4f' % radam_score[1])


adam_model = get_model('adam')
adam_model.fit(
    x=x_train,
    y=y_train,
    epochs=10,
...
adam_score = adam_model.evaluate(x_test, y_test)
