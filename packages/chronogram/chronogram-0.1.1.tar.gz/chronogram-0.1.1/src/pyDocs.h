...
DOC_SIGNATURE_EN(CGM___init____doc__,
	"Chronogram(m=100, l=6, subsampling=1e-4, word_ns=5, time_ns=5, eta=1, zeta=0.1, lambda_v=0.1, seed=None)",
	u8R""()"");
...
DOC_SIGNATURE_EN(CGM_initialize__doc__,
	"initialize(self, reader, workers=0, window_len=4, start_lr=0.025, end_lr=0.00025, batch_size=1000, epochs=1, report=10000)",
	u8R""()"");

DOC_SIGNATURE_EN(CGM_train__doc__,
	"train(self, reader, workers=0, window_len=4, start_lr=0.025, end_lr=0.00025, batch_size=1000, epochs=1, report=10000)",
	u8R""()"");
...
DOC_SIGNATURE_EN(CGM_initialize_gn__doc__,
	"initialize_gn(self, ngram_file, max_items=-1, workers=0, start_lr=0.025, end_lr=0.00025, batch_size=1000, epochs=1, report=10000)",
	u8R""()"");

DOC_SIGNATURE_EN(CGM_train_gn__doc__,
	"train_gn(self, ngram_file, max_items=-1, workers=0, start_lr=0.025, end_lr=0.00025, batch_size=1000, epochs=1, report=10000)",
	u8R""()"");

DOC_SIGNATURE_EN(CGM_most_similar__doc__,
	"most_similar(self, positives, negatives=None, time=None, m=0, topN=10, normalize=False)",
	u8R""()"");
...
DOC_SIGNATURE_EN(CGM_most_similar_s__doc__,
	"most_similar_s(self, positives, negatives=None, topN=10)",
	u8R""()"");
