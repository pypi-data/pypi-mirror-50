...
setup(
    ...
    keywords='tendril',
    url='https://github.com/tendril-framework/tendril-dox-render',
    project_urls={
        'Documentation': 'https://tendril-dox-render.readthedocs.io/en/latest',
        'Bug Tracker': 'https://github.com/tendril-dox-render/tendril-schema/issues',
        'Source Repository': 'https://github.com/tendril-framework/tendril-dox-render',
    },
