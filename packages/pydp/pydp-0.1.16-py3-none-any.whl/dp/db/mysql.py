...
if __name__ == '__main__':
    ...
    print(ret)
    # update
    ret = db.update(table, {'id': 2}, {'val': '222'})
    print(ret)
    # *注：通过观察可以发现，autocommit=False时，以上既没有begin也没有commit的代码部分其实也被自动启动了transation，在下边begin时被自动commit了
    ...
    res = db.query(table, select='val', where={'id': '< 3'})
    print(res)
