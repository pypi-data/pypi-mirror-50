...
class Experiment(CnvrgJob):
    ...
    @staticmethod
    def run(command=None, callable=None, title=None, project=None, compute=None, computes=None, datasets=None, dataset=None, local=False, library=None, working_directory=None, sync_before=True, sync_after=False, **kwargs):
        project = project or Project()
        ...
        if callable:
            ...
            experiment = Experiment.__run_callable(callable, title=title, project=project, library=library, cmd=cmd)
        elif local:
