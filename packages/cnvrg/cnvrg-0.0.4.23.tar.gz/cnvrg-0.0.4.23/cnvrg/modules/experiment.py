...
class Experiment(CnvrgJob):
    ...
    @staticmethod
    def run(command=None, callable=None, title=None, project=None, compute=None, computes=None, datasets=None, dataset=None, local=True, library=None, working_directory=None, sync_before=True, sync_after=False, **kwargs):
        project = project or Project()
