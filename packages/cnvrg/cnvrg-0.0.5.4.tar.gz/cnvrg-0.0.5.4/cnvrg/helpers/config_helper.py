...
def get_element_slug(working_dir=None):
    ...
    return env_helper.CURRENT_PROJECT_SLUG or config.get(":project_name") or config.get("project_name") or config.get("project") or config.get(":dataset_name") or config.get("dataset_name") or config.get("dataset")
