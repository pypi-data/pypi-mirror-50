.. note::
    ...
    Click :ref:`here <sphx_glr_download_auto_examples_plot_clustering_oversampling.py>` to download the full example code
.. rst-class:: sphx-glr-example-title

.. _sphx_glr_auto_examples_plot_clustering_oversampling.py:
...
.. code-block:: default
    ...
    def generate_imbalanced_data():
        ...
        X, y = make_classification(n_classes=3, class_sep=0.8,
                                   weights=[0.01, 0.05, 0.94], n_informative=2,
                                   n_redundant=0, n_repeated=0, n_features=2,
    ...
    def compare_f1_scores(X_train, X_test, y_train, y_test, clf, over_sampler, clusterer):
        ...
        clr_ovs_clf = make_pipeline(clone(over_sampler).set_params(clusterer=clusterer), clf)
        ...
        return pd.DataFrame([[ovs_score, clr_ovs_score]], columns=['No clustering', clr_name], index=[ovs_name])
...
.. image:: /auto_examples/images/sphx_glr_plot_clustering_oversampling_001.png
...
.. image:: /auto_examples/images/sphx_glr_plot_clustering_oversampling_002.png
    :class: sphx-glr-single-img
...
.. rst-class:: sphx-glr-script-out
 ...
 .. code-block:: none
    ...
    RandomOverSampler       0.748158  0.797978
    SMOTE                   0.611372  0.808191
    BorderlineSMOTE         0.751752  0.820453
...
.. rst-class:: sphx-glr-script-out
 ...
 .. code-block:: none
    ...
    RandomOverSampler       0.748158                 0.780695
    SMOTE                   0.611372                 0.808191
    BorderlineSMOTE         0.751752                 0.827006
...
.. _sphx_glr_download_auto_examples_plot_clustering_oversampling.py:
...
.. only :: html
 ...
 .. container:: sphx-glr-footer
  ...
  .. container:: sphx-glr-download
     ...
     :download:`Download Python source code: plot_clustering_oversampling.py <plot_clustering_oversampling.py>`



  .. container:: sphx-glr-download

     :download:`Download Jupyter notebook: plot_clustering_oversampling.ipynb <plot_clustering_oversampling.ipynb>`
