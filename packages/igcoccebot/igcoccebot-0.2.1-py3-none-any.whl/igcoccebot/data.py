...
from igcoccebot.IGNavigation import IGNavigation
# to manage tools
from igcoccebot.tools import save_to_csv, save_to_xls, parse_2_int
# to manage obj detection
from igcoccebot.yolo import *
# to manage images
...
class IGData():
    ...
    def get_info_post(self, pixels=False, obj_detection=False):
        ...
        if self.ig_navigation.am_i_on_a_post():
            ...
            # is video
            info_post["is_video"] = self.ig_navigation.is_video()
            # image link
            ...
            if info_post["img_link"] is not None:
                ...
                if result == 1:
                    # pixels RGB
                    if pixels:
                        info_post["pixels"] = self.get_pixels_RGB("./img_1.png")
                    else:
                        info_post["pixels"] = None
                    # obj detection
                    if obj_detection:
                        info_post["obj_detection"] = self.get_image_obj_detection("./img_1.png")
                    else:
    ...
    def get_pixels_RGB(self, image_path):
        """
    ...
    def get_tags_in_pic(self, unique=True):
        ...
        if self.ig_navigation.am_i_on_a_post():
            try:
                ...
                self.ig_bot.move_and_click_element(self.ig_bot.driver.find_element_by_class_name('_9AhH0'))
                time.sleep(0.5)
    ...
    def get_image_obj_detection(self, image_path, yolo_settings=None):
        """
    ...
    def get_obj_detection(self, yolo_settings=None):
        """
        ...
        if img_link is not None:
            ...
            if status == 1:
                # obj detection
                obj = self.get_image_obj_detection("./img_1.png")
                os.remove("./img_1.png")  # remove image after analysis
            else:
                return None
            return obj
