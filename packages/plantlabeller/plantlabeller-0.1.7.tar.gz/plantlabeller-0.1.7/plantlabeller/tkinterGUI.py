...
def kmeansclassify(bandchoice,classentry):
    ...
    clusternumber=int(classentry.get("1.0",END))
    ...
    checkboxframe=LabelFrame(panelB,text='Select plants (click "Generate plant" to see results)',name='kmeansresult')
...
def KMeansPanel():
    ...
    clusternumberentry=Text(panelB,height=1,width=10)
