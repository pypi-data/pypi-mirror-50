...
setup(
    ...
    keywords='tendril',
    url='https://github.com/tendril-framework/tendril-prototype-base',
    project_urls={
        'Documentation': 'https://tendril-prototype-base.readthedocs.io/en/latest',
        'Bug Tracker': 'https://github.com/tendril-framework/tendril-prototype-base/issues',
        'Source Repository': 'https://github.com/tendril-framework/tendril-prototype-base',
    },
