...
setup(
    ...
    keywords='tendril',
    url='https://github.com/tendril-framework/tendril-utils-markdown',
    project_urls={
        'Documentation': 'https://tendril-utils-markdown.readthedocs.io/en/latest',
        'Bug Tracker': 'https://github.com/tendril-framework/tendril-utils-markdown/issues',
        'Source Repository': 'https://github.com/tendril-framework/tendril-utils-markdown',
    },
