...
class TestObservation:
    def test__constructor_and_specific_instrument_class_methods(self):
        ...
        lsst_psf = abstract_data.PSF.from_gaussian(
            shape=(31, 31), sigma=0.5, pixel_scale=0.2
        )
        ...
        euclid_psf = abstract_data.PSF.from_gaussian(
            shape=(31, 31), sigma=0.1, pixel_scale=0.1
        )
        ...
        hst_psf = abstract_data.PSF.from_gaussian(
            shape=(31, 31), sigma=0.05, pixel_scale=0.05
        )
