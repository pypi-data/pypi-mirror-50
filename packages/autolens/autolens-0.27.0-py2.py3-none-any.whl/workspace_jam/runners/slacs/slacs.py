...
pipeline_initialize = lens_bulge_disk_sie_shear_source_sersic.make_pipeline(
...
pipeline_inversion = lens_bulge_disk_sie_shear_source_inversion.make_pipeline(
    phase_folders=[data_filter, data_name],
...
pipeline_power_law = lens_bulge_disk_pl_shear_source_inversion.make_pipeline(
    phase_folders=[data_filter, data_name],
    pipeline_pixelization=pipeline_pixelization,
    pipeline_regularization=pipeline_regularization,
    positions_threshold=1.0,
