...
class CCDObservation(object):
    ...
    def simulate_ccd_data_from_galaxies(
        ...
        3) Simulate the CCD instrument, using a special image-plane image which ensures edge-effects don't
        ...
        5) Output the instrument to .fits format if a data_path and data_name are specified. Otherwise, return the simulated \
