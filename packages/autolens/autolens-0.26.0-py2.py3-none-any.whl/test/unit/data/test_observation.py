...
from autolens.data.observation import ccd
...
class TestObservation:
    def test__constructor_and_specific_instrument_class_methods(self):
        ...
        lsst_psf = abstract_data.PSF.from_gaussian(shape=(31, 31), sigma=0.5, pixel_scale=0.2)
        ...
        euclid_psf = abstract_data.PSF.from_gaussian(shape=(31, 31), sigma=0.1, pixel_scale=0.1)
        ...
        hst_psf = abstract_data.PSF.from_gaussian(shape=(31, 31), sigma=0.05, pixel_scale=0.05)
        ...
        hst_up_sampled_psf = abstract_data.PSF.from_gaussian(
        ...
        adaptive_optics_psf = abstract_data.PSF.from_gaussian(
    ...
    def test__simulate_ccd_data_from_lens_and_source_galaxy__compare_to_manual_ccd_data(
        ...
        shape = (11, 11)
        pixel_scale = 0.2
        psf = abstract_data.PSF.from_gaussian(shape=(7, 7), sigma=0.1, pixel_scale=0.2)
        exposure_time = 100.0
        ...
        assert ccd_data.background_noise_map == observation_ccd_data.background_noise_map
    ...
    def test__simulate_ccd_data_from_lens_and_source_galaxy__and_write_to_fits(self):
        ...
        observation_ccd_data_loaded = ccd.load_ccd_data_from_fits(
        ...
        assert (
            ccd_data.background_sky_map == observation_ccd_data_loaded.background_sky_map
        ).all()
