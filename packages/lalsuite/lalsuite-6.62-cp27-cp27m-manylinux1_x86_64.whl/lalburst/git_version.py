...
id = "a75e6c243c5695e1abdcc4e5d91f623cf0db1d22"
date = "2019-08-4 16:12:28 +0000"
branch = "None"
tag = "lalsuite-v6.62"
if tag == "None":
    tag = None
...
def check_match(foreign_id, onmismatch="raise"):
    ...
    if foreign_id == "a75e6c243c5695e1abdcc4e5d91f623cf0db1d22":
        return
    msg = "Program id (a75e6c243c5695e1abdcc4e5d91f623cf0db1d22) does not match given id (%s)." % foreign_id
    if onmismatch == "raise":
