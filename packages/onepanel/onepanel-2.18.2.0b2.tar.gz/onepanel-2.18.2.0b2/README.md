...
```bash
TAG=2.18.2.0b2 REGISTRY=us.gcr.io/onepanelio make publish-pip-package
```
...
```bash
TAG=2.18.2.0b1 REGISTRY=us.gcr.io/onepanelio make build-docker-image push-docker-image
```
