...
snake_case_functions = ('log_gabor_freq_image_source', 'butterworth_filter_freq_image_source', 'sinusoid_image_source', 'steerable_filter_freq_image_source', 'phase_symmetry_image_filter', )
