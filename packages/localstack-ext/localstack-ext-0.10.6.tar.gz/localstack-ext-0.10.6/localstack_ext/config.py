...
# RDS service port ranges (TODO: currently limited to 10 entries)
RDS_PORTS_START = 4530
RDS_PORTS_END = RDS_PORTS_START + 10

# ElastiCache service port ranges (TODO: currently limited to 10 entries)
ELASTICACHE_PORTS_START = 4520
ELASTICACHE_PORTS_END = ELASTICACHE_PORTS_START + 10
