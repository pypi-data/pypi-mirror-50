...
class EntitiesApi(object):
    ...
    def entities_tool_read(self, tool_id, **kwargs):  # noqa: E501
        """entities_tool_read  # noqa: E501

          # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.entities_tool_read(tool_id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.entities_tool_read_with_http_info(tool_id, **kwargs)  # noqa: E501
        else:
            (data) = self.entities_tool_read_with_http_info(tool_id, **kwargs)  # noqa: E501
            return data

    def entities_tool_read_with_http_info(self, tool_id, **kwargs):  # noqa: E501
        """entities_tool_read  # noqa: E501

          # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.entities_tool_read_with_http_info(tool_id, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method entities_tool_read" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        if ('tool_id' not in params or
            ...
            raise ValueError("Missing the required parameter `tool_id` when calling `entities_tool_read`")  # noqa: E501

        collection_formats = {}

        path_params = {}
        if 'tool_id' in params:
            path_params['tool_id'] = params['tool_id']  # noqa: E501
    ...
    def entities_tool_read_0(self, format, tool_id, **kwargs):  # noqa: E501
        """entities_tool_read_0  # noqa: E501

          # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.entities_tool_read_0(format, tool_id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.entities_tool_read_0_with_http_info(format, tool_id, **kwargs)  # noqa: E501
        else:
            (data) = self.entities_tool_read_0_with_http_info(format, tool_id, **kwargs)  # noqa: E501
            return data

    def entities_tool_read_0_with_http_info(self, format, tool_id, **kwargs):  # noqa: E501
        """entities_tool_read_0  # noqa: E501

          # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.entities_tool_read_0_with_http_info(format, tool_id, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['format', 'tool_id']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method entities_tool_read_0" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        if ('format' not in params or
            ...
            raise ValueError("Missing the required parameter `format` when calling `entities_tool_read_0`")  # noqa: E501
        # verify the required parameter 'tool_id' is set
        if ('tool_id' not in params or
                params['tool_id'] is None):
            raise ValueError("Missing the required parameter `tool_id` when calling `entities_tool_read_0`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/entities/tool/{tool_id}{format}', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
