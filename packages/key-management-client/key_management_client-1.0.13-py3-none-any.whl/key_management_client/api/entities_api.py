...
class EntitiesApi(object):
    ...
    def entities_externalid_organizationtype_read(self, external_id, ontology_type, **kwargs):  # noqa: E501
        """entities_externalid_organizationtype_read  # noqa: E501

          # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.entities_externalid_organizationtype_read(external_id, ontology_type, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.entities_externalid_organizationtype_read_with_http_info(external_id, ontology_type, **kwargs)  # noqa: E501
        else:
            (data) = self.entities_externalid_organizationtype_read_with_http_info(external_id, ontology_type, **kwargs)  # noqa: E501
            return data

    def entities_externalid_organizationtype_read_with_http_info(self, external_id, ontology_type, **kwargs):  # noqa: E501
        """entities_externalid_organizationtype_read  # noqa: E501

          # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.entities_externalid_organizationtype_read_with_http_info(external_id, ontology_type, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method entities_externalid_organizationtype_read" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        if ('external_id' not in params or
            ...
            raise ValueError("Missing the required parameter `external_id` when calling `entities_externalid_organizationtype_read`")  # noqa: E501
        # verify the required parameter 'ontology_type' is set
        if ('ontology_type' not in params or
                params['ontology_type'] is None):
            raise ValueError("Missing the required parameter `ontology_type` when calling `entities_externalid_organizationtype_read`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/entities/externalid/{external_id}/organizationtype/{ontology_type}/', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def entities_externalid_organizationtype_read_0(self, external_id, format, ontology_type, **kwargs):  # noqa: E501
        """entities_externalid_organizationtype_read_0  # noqa: E501

          # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.entities_externalid_organizationtype_read_0(external_id, format, ontology_type, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.entities_externalid_organizationtype_read_0_with_http_info(external_id, format, ontology_type, **kwargs)  # noqa: E501
        else:
            (data) = self.entities_externalid_organizationtype_read_0_with_http_info(external_id, format, ontology_type, **kwargs)  # noqa: E501
            return data

    def entities_externalid_organizationtype_read_0_with_http_info(self, external_id, format, ontology_type, **kwargs):  # noqa: E501
        """entities_externalid_organizationtype_read_0  # noqa: E501

          # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.entities_externalid_organizationtype_read_0_with_http_info(external_id, format, ontology_type, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method entities_externalid_organizationtype_read_0" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'external_id' is set
        if ('external_id' not in params or
                params['external_id'] is None):
            raise ValueError("Missing the required parameter `external_id` when calling `entities_externalid_organizationtype_read_0`")  # noqa: E501
        # verify the required parameter 'format' is set
        if ('format' not in params or
                params['format'] is None):
            raise ValueError("Missing the required parameter `format` when calling `entities_externalid_organizationtype_read_0`")  # noqa: E501
        # verify the required parameter 'ontology_type' is set
        if ('ontology_type' not in params or
                params['ontology_type'] is None):
            raise ValueError("Missing the required parameter `ontology_type` when calling `entities_externalid_organizationtype_read_0`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/entities/externalid/{external_id}/organizationtype/{ontology_type}{format}', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
