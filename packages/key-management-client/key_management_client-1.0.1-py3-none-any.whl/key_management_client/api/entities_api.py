...
class EntitiesApi(object):
    ...
    def entities_read_0(self, format, tool_id, **kwargs):  # noqa: E501
        """entities_read_0  # noqa: E501

          # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.entities_read_0(format, tool_id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.entities_read_0_with_http_info(format, tool_id, **kwargs)  # noqa: E501
        else:
            (data) = self.entities_read_0_with_http_info(format, tool_id, **kwargs)  # noqa: E501
            return data

    def entities_read_0_with_http_info(self, format, tool_id, **kwargs):  # noqa: E501
        """entities_read_0  # noqa: E501

          # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.entities_read_0_with_http_info(format, tool_id, async_req=True)
        >>> result = thread.get()
        ...
        if ('format' not in params or
            ...
            raise ValueError("Missing the required parameter `format` when calling `entities_read_0`")  # noqa: E501
        # verify the required parameter 'tool_id' is set
        if ('tool_id' not in params or
                params['tool_id'] is None):
            raise ValueError("Missing the required parameter `tool_id` when calling `entities_read_0`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/entities/{tool_id}/tool_id{format}', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def entities_tool_id_list(self, tool_id, **kwargs):  # noqa: E501
        """entities_tool_id_list  # noqa: E501

          # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.entities_tool_id_list(tool_id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.entities_tool_id_list_with_http_info(tool_id, **kwargs)  # noqa: E501
        else:
            (data) = self.entities_tool_id_list_with_http_info(tool_id, **kwargs)  # noqa: E501
            return data

    def entities_tool_id_list_with_http_info(self, tool_id, **kwargs):  # noqa: E501
        """entities_tool_id_list  # noqa: E501

          # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.entities_tool_id_list_with_http_info(tool_id, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method entities_tool_id_list" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'tool_id' is set
        if ('tool_id' not in params or
                params['tool_id'] is None):
            raise ValueError("Missing the required parameter `tool_id` when calling `entities_tool_id_list`")  # noqa: E501
