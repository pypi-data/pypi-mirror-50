...
class MintMethod(ContractMethod):
    ...
    def call(
        ...
        tx_params = super().normalize_tx_params(tx_params)
        return self.underlying_method(_value).call(tx_params.as_dict())
    ...
    def send_transaction(
        ...
        (_value) = self.validate_and_normalize_inputs(_value)
        tx_params = super().normalize_tx_params(tx_params)
        return self.underlying_method(_value).transact(tx_params.as_dict())
    ...
    def estimate_gas(
        ...
        (_value) = self.validate_and_normalize_inputs(_value)
        tx_params = super().normalize_tx_params(tx_params)
        return self.underlying_method(_value).estimateGas(tx_params.as_dict())
...
class SetBalanceMethod(ContractMethod):
    ...
    def call(
        ...
        tx_params = super().normalize_tx_params(tx_params)
        return self.underlying_method(_target, _value).call(
            tx_params.as_dict()
        )
    ...
    def send_transaction(
        ...
        (_target, _value) = self.validate_and_normalize_inputs(_target, _value)
        tx_params = super().normalize_tx_params(tx_params)
        return self.underlying_method(_target, _value).transact(
            tx_params.as_dict()
        )
    ...
    def estimate_gas(
        ...
        (_target, _value) = self.validate_and_normalize_inputs(_target, _value)
        tx_params = super().normalize_tx_params(tx_params)
        return self.underlying_method(_target, _value).estimateGas(
            tx_params.as_dict()
        )
