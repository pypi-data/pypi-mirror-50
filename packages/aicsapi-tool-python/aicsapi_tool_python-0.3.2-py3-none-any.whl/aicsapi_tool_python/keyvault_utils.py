...
import json
import tempfile
from aicsapi_tool_python.keyvault_tokenCache import TokenCache
...
def keyvault_client_auth():
    ...
    auth_context = adal.AuthenticationContext('https://login.microsoftonline.com/' + os.getenv('AZURE_TENANT_ID'))
