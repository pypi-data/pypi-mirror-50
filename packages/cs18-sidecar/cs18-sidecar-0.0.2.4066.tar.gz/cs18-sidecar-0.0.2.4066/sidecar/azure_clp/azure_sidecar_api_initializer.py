...
from sidecar.sandbox_public_address_fetcher import AzureSandboxPublicAddressFetcher
...
class AzureSidecarApiInitializer:
    ...
    def initialize(self):
        ...
        app_service = AzureAppService(status_maintainer=azure_status_maintainer,
                                      logger=self._logger)
