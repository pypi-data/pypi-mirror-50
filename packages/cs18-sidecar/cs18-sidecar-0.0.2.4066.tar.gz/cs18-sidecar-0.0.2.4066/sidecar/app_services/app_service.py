...
class AzureAppService(AppService):
    def __init__(self, status_maintainer: AzureStatusMaintainer, logger: Logger):
        super().__init__(logger)
        self.status_maintainer = status_maintainer

    def update_network_status(self, app_name: str, status: str):
        self.status_maintainer.update_logical_app_healthcheck_status(app_name=app_name, status=status)

    def update_artifacts_status(self, app_name: str, status: str):
        self.status_maintainer.update_logical_app_artifacts_status(app_name=app_name, status=status)
