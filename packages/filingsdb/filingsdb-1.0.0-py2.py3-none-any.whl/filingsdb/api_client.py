...
import filingsdb.models
from filingsdb import rest
...
class ApiClient(object):
    ...
    def __init__(
        ...
        self.user_agent = "filingsdb-python/1.0.0/python"
    ...
    @property
    def user_agent(self):
        """User agent for the filingsdb API client"""
    ...
    def __call_api(
        ...
        if config.api_key:
            header_params["Authorization"] = "Bearer " + config.api_key
        if header_params:
    ...
    def __deserialize(self, data, klass):
        ...
        if type(klass) == str:
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(filingsdb.models, klass)
