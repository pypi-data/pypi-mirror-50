...
def write_dags_zljianzhu(dirname,**krg):
    write_dags_zljianzhu_gg(dirname, loc="aliyun",pool="abc_a7", **krg)
    write_dags_zljianzhu_html(dirname, loc="aliyun",pool="abc_a7",daydelta=10, **krg)
