...
setup(
    ...
    keywords='tendril',
    url='https://github.com/tendril-framework/tendril-utils-gerber',
    project_urls={
        'Documentation': 'https://tendril-utils-gerber.readthedocs.io/en/latest',
        'Bug Tracker': 'https://github.com/tendril-framework/tendril-utils-gerber/issues',
        'Source Repository': 'https://github.com/tendril-framework/tendril-utils-gerber',
    },
