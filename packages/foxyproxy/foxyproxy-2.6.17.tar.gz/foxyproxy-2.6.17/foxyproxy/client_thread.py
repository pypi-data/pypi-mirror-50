...
class ClientThread(Process):
    ...
    """
    def __init__(self, protocol, connection, signer, queue_out, _id):
        """
        ...
        self.init(protocol, connection, signer, queue_out, _id)

    def init(self, protocol, connection, signer, queue_out, _id=None):
        """
        Repeating use
        :param protocol:
        :param connection:
