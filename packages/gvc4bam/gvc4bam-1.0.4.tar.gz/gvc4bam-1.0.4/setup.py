...
setup(
    name='gvc4bam',     # 包名字
    version='1.0.4',   # 包版本
    description='Gvc4fastq is a pipeline developed at Genowis for germline and somatic mutation(snv, indel, sv) in next generation sequencing data from bam.',   # 简单描述
