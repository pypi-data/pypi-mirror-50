...
with at least three columns: chrName, startPosition and endPostion""")
    ...
    parser.add_argument(
        ...
        action='append',
        default=[])
    parser.add_argument('--strategy', choices=['WES', 'Panel','WGS'],help='Switch algorithm for WES, Panel or WGS analysis', required=True)
    parser.add_argument(
...
if __name__ == "__main__":
    ...
    commandLine = ['python', absPath + '/gvc_vcf_pipeline.py', options.outpath + '/jobStore', options.input_json, options.reference,
                   options.outpath]
