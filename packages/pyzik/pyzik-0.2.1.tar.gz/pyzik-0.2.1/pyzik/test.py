...
from pandly import del_columns,derive, norme, delta, f_input
import pandas as pd
...
class TestFunctions():
    from pandly import give_me_crypto as __give_me_crypto,get_SPY as __get_SPY,SPY_KEY as __SPY_KEY
    __EXTRA_DELIMITER = '|'
