...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'random', 'v0.5.7-dev.1565105198+g4ae0e25'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource random v0.5.7-dev.1565105198+g4ae0e25`
                """)
            else:
                raise
