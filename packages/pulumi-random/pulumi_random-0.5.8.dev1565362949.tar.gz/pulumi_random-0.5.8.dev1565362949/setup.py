...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'random', 'v0.5.8-dev.1565362949+g0bbf455'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource random v0.5.8-dev.1565362949+g0bbf455`
                """)
            else:
                raise
