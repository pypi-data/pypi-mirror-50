...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'random', 'v0.5.9-dev.1565717117+gba16c1f'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource random v0.5.9-dev.1565717117+gba16c1f`
                """)
            else:
                raise
