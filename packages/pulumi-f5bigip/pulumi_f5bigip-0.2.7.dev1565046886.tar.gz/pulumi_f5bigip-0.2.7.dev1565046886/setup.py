...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'f5bigip', 'v0.2.7-dev.1565046886+gdb1361d'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource f5bigip v0.2.7-dev.1565046886+gdb1361d`
                """)
            else:
                raise
