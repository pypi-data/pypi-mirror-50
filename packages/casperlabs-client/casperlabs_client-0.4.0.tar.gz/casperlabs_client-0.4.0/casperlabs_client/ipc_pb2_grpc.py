...
class ExecutionEngineServiceStub(object):
  ...
  def __init__(self, channel):
    ...
    self.exec = channel.unary_unary(
        '/io.casperlabs.ipc.ExecutionEngineService/exec',
        request_serializer=ipc__pb2.ExecRequest.SerializeToString,
        response_deserializer=ipc__pb2.ExecResponse.FromString,
        )
    ...
    self.run_genesis = channel.unary_unary(
        ...
        request_serializer=ipc__pb2.GenesisRequest.SerializeToString,
...
def add_ExecutionEngineServiceServicer_to_server(servicer, server):
  rpc_method_handlers = {
      'exec': grpc.unary_unary_rpc_method_handler(
          servicer.exec,
          request_deserializer=ipc__pb2.ExecRequest.FromString,
          response_serializer=ipc__pb2.ExecResponse.SerializeToString,
      ),
      ...
      'run_genesis': grpc.unary_unary_rpc_method_handler(
          ...
          request_deserializer=ipc__pb2.GenesisRequest.FromString,
