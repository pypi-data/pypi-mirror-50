...
class Pax:
    ...
    def test_connection(self):
        ...
        # The correct server should return a JSON object with pin 8090.
        if status == 200 and data is not None and "pin" in data and data["pin"] == 8090:
            return True
        else:
            return False
