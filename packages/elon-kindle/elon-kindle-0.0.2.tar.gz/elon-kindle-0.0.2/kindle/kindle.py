...
def send():
    ...
    if not os.path.exists(file):
        kindle_email = input('kindle邮箱:')
        send_email = input('发送邮箱地址:')
        send_secret = input('发送邮箱密码:')
...
# 发送纯文本邮件:
def send_text_email(subject, content, from_email, from_user, pwd, to_email, to_user, file_path):
