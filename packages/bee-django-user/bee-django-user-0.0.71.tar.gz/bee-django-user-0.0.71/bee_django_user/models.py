...
class UserProfile(models.Model):
    ...
    agent = models.ForeignKey("bee_django_user.UserProfile",related_name='agent_user',null=True, on_delete=models.SET_NULL,
                               blank=True)#客服
    ...
    def to_json(self):
        result = serializer(data=self, output_type='json', datetime_format='string',include_attr=('user_id',"student_id","sn","room_id","user_class","start_date","expire_date","preuser","is_pause"))
