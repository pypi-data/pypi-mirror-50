...
def bunker():
    ...
    parser_extras = subparsers.add_parser('extra', help='install extra software')
    ...
    parser_build.add_argument('-l', action='store_true', help='leave ec2 running.')
    parser_build.add_argument('-s', action='store_true', help='skip startup.')
    ...
    if args.subcommand == 'build':
        ...
        skipstart = args.s
        source = args.repo
        args.func(running, skipstart, source)
    else:
        args.func()
