...
@pass_rebotics_context
def create_camera_settings(ctx, token, store, retailer, camera_type, folder):
    ...
    try:
        ...
        result = ctx.provider.add_camera_settings(retailer, store, token, ct.type)
...
@pass_rebotics_context
def camera_settings_add_roi(ctx, ):
