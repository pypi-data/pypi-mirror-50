...
class ShelfCameraManagerProvider(ReboticsBaseProvider):
    ...
    @remote_service('/api/camera-settings/')
    def add_camera_settings(self, retailer_codename, store_id, token, camera_type, folder):
        """
    ...
    @remote_service('/api/camera-settings/{camera_settings_id}/add-roi/')
    def add_camera_settings(self, camera_settings_id,
                            aisle, section=None,
