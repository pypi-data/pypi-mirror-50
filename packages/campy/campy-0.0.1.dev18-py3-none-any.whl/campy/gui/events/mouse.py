...
def onmouseentered(function):
    _platform.Platform().event_add_mouse_handler(MouseEventType.MOUSE_ENTERED, function)

def onmouseexited(function):
    _platform.Platform().event_add_mouse_handler(MouseEventType.MOUSE_EXITED, function)

def onmousedoubleclicked(function):
    _platform.Platform().event_add_mouse_handler(MouseEventType.MOUSE_DOUBLE_CLICKED, function)

def onmousetripleclicked(function):
    _platform.Platform().event_add_mouse_handler(MouseEventType.MOUSE_TRIPLE_CLICKED, function)
...
def mousepress(x, y, *, window=None, warp=False):
    _platform.Platform().event_mouse_generate(MouseEventType.MOUSE_PRESSED, x, y, window=window, warp=warp)

def mouserelease(x, y, *, window=None, warp=False):
    _platform.Platform().event_mouse_generate(MouseEventType.MOUSE_RELEASED, x, y, window=window, warp=warp)

def mouseclick(x, y, *, window=None, warp=False):
    """Fire a mouse-clicked event."""
    mousepress(x, y, window=window)
    mouserelease(x, y, window=window)

def mousemove(x, y, *, window=None, warp=False):
    _platform.Platform().event_mouse_generate(MouseEventType.MOUSE_MOVED, x, y, window=window, warp=warp)

def mousedrag(x, y, *, window=None, warp=False):
    _platform.Platform().event_mouse_generate(MouseEventType.MOUSE_DRAGGED, x, y, window=window, warp=warp)
