...
class StellarXDRPacker(xdrlib.Packer):
    ...
    def pack_PathPaymentResultCode(self, data):
        ...
        if self.check_enum and data not in [
            const.PATH_PAYMENT_SUCCESS,
            const.PATH_PAYMENT_MALFORMED,
            const.PATH_PAYMENT_UNDERFUNDED,
            const.PATH_PAYMENT_SRC_NO_TRUST,
            const.PATH_PAYMENT_SRC_NOT_AUTHORIZED,
            const.PATH_PAYMENT_NO_DESTINATION,
            const.PATH_PAYMENT_NO_TRUST,
            const.PATH_PAYMENT_NOT_AUTHORIZED,
            const.PATH_PAYMENT_LINE_FULL,
            const.PATH_PAYMENT_NO_ISSUER,
            const.PATH_PAYMENT_TOO_FEW_OFFERS,
            const.PATH_PAYMENT_OFFER_CROSS_SELF,
