...
setup(
    ...
    keywords='tendril',
    url='https://github.com/tendril-framework/tendril-costing',
    project_urls={
        'Documentation': 'https://tendril-costing.readthedocs.io/en/latest',
        'Bug Tracker': 'https://github.com/tendril-framework/tendril-costing/issues',
        'Source Repository': 'https://github.com/tendril-framework/tendril-costing',
    },
