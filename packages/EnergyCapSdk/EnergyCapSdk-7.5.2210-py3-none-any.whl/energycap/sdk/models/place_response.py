...
class PlaceResponse(Model):
    ...
    :type place_info: str
    :param parent: The parent of the place. The parent is the place directly
     above the current place on the buildings and meters tree
    ...
    :param created_by: The user who created the place
    ...
    :param modified_by: The user who most recently modified the place
    ...
    :param primary_use: The place's primary use
    :type primary_use: ~energycap.sdk.models.PrimaryUseChild
    :param weather_station: The weather station the place is assigned to
    :type weather_station: ~energycap.sdk.models.WeatherStationChild
    :param size: Data pertaining to the current floor area when Place Type is
     a structure, when not a structure it is a total of all child floor areas
    ...
    :param energy_star_rating: The most recent ENERGY STAR rating
    ...
    :param contact: The place's contact information
    ...
    def __init__(self, place_id=None, place_code=None, place_info=None, parent=None, place_type=None, created_date=None, created_by=None, modified_date=None, modified_by=None, address=None, build_date=None, primary_use=None, weather_station=None, size=None, energy_star_enabled=None, energy_star_rating=None, places=None, meters=None, contact=None):
