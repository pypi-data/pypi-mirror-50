...
class BillViewResponse(Model):
    ...
    :param batch: The batch to which this bill belongs
    ...
    :param export_hold: Is the bill held from export?
    ...
    :param ap_exported_by: The user who ap exported the bill
    ...
    :param gl_exported_by: The user who exported the bill to gl
