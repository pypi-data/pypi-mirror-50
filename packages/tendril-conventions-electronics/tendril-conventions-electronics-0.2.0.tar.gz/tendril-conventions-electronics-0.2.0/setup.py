...
setup(
    ...
    keywords='tendril',
    url='https://github.com/tendril-framework/tendril-conventions-electronics',
    project_urls={
        'Documentation': 'https://tendril-conventions-electronics.readthedocs.io/en/latest',
        'Bug Tracker': 'https://github.com/tendril-framework/tendril-conventions-electronics/issues',
        'Source Repository': 'https://github.com/tendril-framework/tendril-conventions-electronics',
    },
