...
``tendril-conventions-electronics`` can be installed normally from the Python Package Index.
...
.. code-block:: console
    ...
    $ pip install tendril-conventions-electronics
...
`github releases <https://github.com/tendril-framework/tendril-conventions-electronics/releases>`_.
...
``tendril-conventions-electronics``. ``sudo`` may be necessary if you are not installing
into a virtual environment.

.. code-block:: console

    $ git clone https://github.com/tendril-framework/tendril-conventions-electronics.git
    $ cd tendril-conventions-electronics
    $ pip install -e .
