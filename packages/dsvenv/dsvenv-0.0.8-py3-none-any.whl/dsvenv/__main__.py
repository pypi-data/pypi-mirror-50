...
def verify_environment(only_warning=True):
    ...
    if expected_python is None and expected_dsvenv is None:
        return
    ...
    if expected_python != this_python:
    ...
    if expected_dsvenv != this_dsvenv:
...
def initialize_venv(venv_dir, reqs_file, extra_reqs=(), install_pre_commit=True):
    """
    ...
    Args:
        ...
        extra_reqs (list of str): Paths to extra requirements files to be installed.
