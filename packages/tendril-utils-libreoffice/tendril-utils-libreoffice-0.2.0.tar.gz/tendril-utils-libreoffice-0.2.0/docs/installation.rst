...
``tendril-utils-libreoffice`` can be installed normally from the Python Package Index.
...
.. code-block:: console
    ...
    $ pip install tendril-utils-libreoffice
...
`github releases <https://github.com/tendril-framework/tendril-utils-libreoffice/releases>`_.
...
``tendril-utils-libreoffice``. ``sudo`` may be necessary if you are not 
installing into a virtual environment.

.. code-block:: console

    $ git clone https://github.com/tendril-framework/tendril-utils-libreoffice.git
    $ cd tendril-utils-libreoffice
    $ pip install -e .
