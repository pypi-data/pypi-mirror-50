...
class ImageSetUploadView(TestCase):
    ...
    def test_upload_by_anonymous(self):
        ...
        """
        self.get("artek_images:imageset_new_upload")
    ...
    def test_upload_get(self):
        ...
        """
        path = reverse("artek_images:imageset_new_upload")
    ...
    def test_upload_new_imageset(self):
        ...
        """
        url = "artek_images:imageset_new_upload"
    ...
    def test_upload_image(self):
        ...
        post_data = {"files": self.image_file}
        url = "artek_images:imageset_upload"
        with self.login(self.user):
...
class ImageSetDetailView(ImageSetMixin, TestCase):
    ...
    def setUp(self):
        ...
        self.view_url = "artek_images:imageset_detail"
...
class ImageDeleteView(ImageSetMixin, TestCase):
    ...
    def setUp(self):
        ...
        self.view_url = "artek_images:image_delete"
...
class ImageTogglePrimaryView(ImageSetMixin, TestCase):
    ...
    def setUp(self):
        ...
        self.view_url = "artek_images:image_make_primary"
