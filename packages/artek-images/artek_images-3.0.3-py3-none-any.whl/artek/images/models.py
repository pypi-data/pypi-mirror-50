...
def image_upload_to(instance, filename):
    ...
    return "artek-images/image-set-{}/{}.{}".format(instance.image_set.pk, uid, ext)
...
class ImageSet(models.Model):
    ...
    def image_data(self):
        return {
            ...
            "upload_url": reverse("artek_images:imageset_upload", args=[self.pk])
        }
...
class Image(models.Model):
    ...
    thumbnail = ImageSpecField(source="image", id="artek_images:image:thumbnail")
    list_thumbnail = ImageSpecField(source="image", id="artek_images:image:list_thumbnail")
    small_thumbnail = ImageSpecField(source="image", id="artek_images:image:small_thumbnail")
    medium_thumbnail = ImageSpecField(source="image", id="artek_images:image:medium_thumbnail")
    ...
    def data(self):
        return {
            ...
            "delete_url": reverse("artek_images:image_delete", args=[self.pk]),
            "make_primary_url": reverse("artek_images:image_make_primary", args=[self.pk])
        }
