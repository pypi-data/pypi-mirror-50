...
class GraphUserMailAddressCreationContext(GraphUserCreationContext):
    ...
    def __init__(self, storage_key=None, mail_address=None):
        super(GraphUserMailAddressCreationContext, self).__init__(storage_key=storage_key)
...
class GraphUserOriginIdCreationContext(GraphUserCreationContext):
    ...
    :param storage_key: Optional: If provided, we will use this identifier for the storage key of the created user
    :type storage_key: str
    :param origin: This should be the name of the origin provider. Example: github.com
    :type origin: str
    :param origin_id: This should be the object id or sid of the user from the source AD or AAD provider. Example: d47d025a-ce2f-4a79-8618-e8862ade30dd Team Services will communicate with the source provider to fill all other fields on creation.
    :type origin_id: str
    """
    ...
    def __init__(self, storage_key=None, origin=None, origin_id=None):
        super(GraphUserOriginIdCreationContext, self).__init__(storage_key=storage_key)
        self.origin = origin
        self.origin_id = origin_id
...
class GraphUserPrincipalNameCreationContext(GraphUserCreationContext):
    ...
    :param storage_key: Optional: If provided, we will use this identifier for the storage key of the created user
    :type storage_key: str
    :param principal_name: This should be the principal name or upn of the user in the source AD or AAD provider. Example: jamal@contoso.com Team Services will communicate with the source provider to fill all other fields on creation.
    ...
    def __init__(self, storage_key=None, principal_name=None):
        super(GraphUserPrincipalNameCreationContext, self).__init__(storage_key=storage_key)
