...
to_json_type = {
		...
		DT_Binary:      JsonDatatype.any
		}

from_json_type = {
		JsonDatatype.any:      DT_Text,
		JsonDatatype.integer:  DT_Integer,
		JsonDatatype.number:   DT_Float,
		JsonDatatype.boolean:  DT_Boolean,
		JsonDatatype.string:   DT_Text,
		JsonDatatype.date:     DT_Date,
		JsonDatatype.datetime: DT_Timestamp
		}
