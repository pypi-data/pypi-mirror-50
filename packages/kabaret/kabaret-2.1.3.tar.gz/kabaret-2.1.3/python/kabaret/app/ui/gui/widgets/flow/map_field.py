    ...
    def update_row(self, row):
        ...
        if background:
            for i in range(self.columnCount()):
                self.setBackground(i, QtGui.QBrush(QtGui.QColor(*background)))

        foreground = style.get('foreground-color')
        if foreground:
            for i in range(self.columnCount()):
                self.setForeground(i, QtGui.QBrush(QtGui.QColor(*foreground)))
        ...
        for i, col in enumerate(columns):
            ...
            background = style.get(col + '_background-color')
            if background:
                self.setBackground(i, QtGui.QBrush(QtGui.QColor(*background)))

            foreground = style.get(col + '_foreground-color')
            if foreground:
                self.setForeground(i, QtGui.QBrush(QtGui.QColor(*foreground)))
