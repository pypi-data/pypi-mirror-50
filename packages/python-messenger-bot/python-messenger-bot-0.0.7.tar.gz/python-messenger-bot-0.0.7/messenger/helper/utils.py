...
class Utils:
    ...
    #merge with json_to_var
    def json_to_var2(self, json):
    ...
    #merge with json_to_var
    def json_to_var3(self, json):
        thread_type = json['thread_type']
        tid = json['tid']
        sender_psid = json['psid']
        signed_request = json['signed_request']

        message = Message()
        message.json_to_message({'text': signed_request})

        return sender_psid, message