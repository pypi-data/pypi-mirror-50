...
|PyTecplot| is supported on 64 bit Python versions 2.7 and 3.5+. |PyTecplot|
...
1. Verify that you have installed and can run |Tecplot 360| version **2017
   R1** *or later*.
2. Verify that you are running 64 bit Python version ``2.7`` or ``3.5+``.
