...
class PieCharts(session.Style):
    ...
    .. code-block:: python
        ...
        for fmap in plot.fieldmaps():
            fmap.scatter.symbol().shape = GeomShape.PieChart
            fmap.scatter.size = 4.0
    ...
    def __init__(self, scatter):
        ...
        super().__init__(scatter._sv, sv.PIECHARTS, **scatter._style_attrs)
...
class Scatter(session.Style):
    ...
    def base_font(self):
        ...
        """
        return text.BaseFont(*self._sv, **self._style_attrs)
