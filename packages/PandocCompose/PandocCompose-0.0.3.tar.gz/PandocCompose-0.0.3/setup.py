...
setup(
    ...
    description="pandoc-compose lets you manage your documentation base using Pandoc",
    ...
    entry_points={
        "console_scripts": ["pandoc-compose=pandoc_compose.pandoc_compose:main"]
    },
)
