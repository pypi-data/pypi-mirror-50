...
class ReferenceGame(data.Dataset):
    ...
    def __getitem__(self, index):
        ...
        if self.split == "Train":
                image_np_1 = os.path.join(DATA_DIR+'train/vision/imgs', distr1)
                image_np_2 = os.path.join(DATA_DIR+'train/vision/imgs', distr2)
                image_np_tgt = os.path.join(DATA_DIR+'train/vision/imgs', target)
        if self.split == "Validation":
                image_np_1 = os.path.join(DATA_DIR+'val/vision/imgs', distr1)
                image_np_2 = os.path.join(DATA_DIR+'val/vision/imgs', distr2)
                image_np_tgt = os.path.join(DATA_DIR+'val/vision/imgs', target)
        if self.split == "Test":
                image_np_1 = os.path.join(DATA_DIR+'test/vision/imgs', distr1)
                image_np_2 = os.path.join(DATA_DIR+'test/vision/imgs', distr2)
                image_np_tgt = os.path.join(DATA_DIR+'test/vision/imgs', target)
