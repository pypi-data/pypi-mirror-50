...
class Engine(object):
    def __init__ (self, dir, hot_start, full_diagnostic, cuda):
        ...
        if not os.path.exists(self.out_dir + "plot_data/"):
            os.makedirs(self.out_dir + "plot_data/")

        if os.path.exists(DIR+ 'seeds_save/' + 'seed.txt'):
        ...
        if os.path.exists(self.dir_data_config+'plot_data/' + 'plot_' + self.name + ".txt"):    
