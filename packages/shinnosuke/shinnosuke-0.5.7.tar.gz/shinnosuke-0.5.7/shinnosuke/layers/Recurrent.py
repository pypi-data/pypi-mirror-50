...
class LSTMCell(Layer):
    ...
    def _initial_params(self, n_in, n_out):
        ...
        W=concatenate(Wf_r,Wf_l,Wu_r,Wu_l,Wc_r,Wc_l,Wo_r,Wo_l,axis=0)
        ...
        b=concatenate(bf,bu,bc,bo,axis=0,name='b')
        del Wf_r, Wf_l, Wu_r, Wu_l, Wc_r, Wc_l, Wo_r, Wo_l,bf,bu,bc,bo
        variables=[W,b]
