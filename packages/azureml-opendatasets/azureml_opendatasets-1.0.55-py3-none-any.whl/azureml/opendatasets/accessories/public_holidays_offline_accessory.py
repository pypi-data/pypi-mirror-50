        ...
        if date_col_name in PublicHolidaysOfflineAccessory.HOLIDAYS_DF.columns:
            if country_code:
                if self.holidays_dates_country_code != country_code:
                    self.holidays_dates = dict.fromkeys(PublicHolidaysOfflineAccessory.HOLIDAYS_DF[
                                                        PublicHolidaysOfflineAccessory.HOLIDAYS_DF.countryRegionCode ==
                ...
                if self.holidays_dates_country != country_or_region:
                    self.holidays_dates = dict.fromkeys(PublicHolidaysOfflineAccessory.HOLIDAYS_DF[
                                                        PublicHolidaysOfflineAccessory.HOLIDAYS_DF.countryOrRegion ==
