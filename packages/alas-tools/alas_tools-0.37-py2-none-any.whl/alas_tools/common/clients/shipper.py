from alas_ce0.clients.api_client import ApiHttpClientBase, ApiClientRequest
...
class ShipperThirdPartyApiClient(ApiHttpClientBase):
    ...
    def get_status(self, id_dispatch):
        return self.http_get("{}status/{}".format(self.entity_endpoint_base_url, id_dispatch))
