...
class FlaskHintful():
    ...
    Args:
        ...
        serializer ([type], optional): Serialization provider. Defaults to Serializer().
        deserializer ([type], optional): Deserialization provider. Defaults to Deserializer().
        openapi_provider ([type], optional): OpenApiProvider. Defaults to OpenApiProvider().
    '''
    ...
    def __init__(self,
        ...
        self.openapi_provider = openapi_provider
