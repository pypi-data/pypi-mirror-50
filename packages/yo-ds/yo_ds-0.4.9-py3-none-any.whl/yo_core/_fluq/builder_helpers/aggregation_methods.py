...
class _FieldListAggregatorComponent:
    def __init__(self, name: str, selector:Callable, agg: ListAggregator):
        self.name=name
...
class _FieldListAggregatorPromise:
    def __init__(self, aggregator: 'Aggregator', name: str, selector: Callable):
        self._name = name
        self._selector = selector
        self._aggregator = aggregator

    def apply(self, *aggs: BaseAggregation):
        self._aggregator._components.append(_FieldListAggregatorComponent(self._name,self._selector,ListAggregator(*aggs)))
