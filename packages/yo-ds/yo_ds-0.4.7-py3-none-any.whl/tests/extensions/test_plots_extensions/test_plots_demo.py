...
from tests.extensions.test_plots_extensions.test_fluent_plot import TestFluentPlot
from tests.extensions.test_plots_extensions.test_grbar import TestGrBar
from tests.extensions.test_plots_extensions.test_other_plots import TestOtherPlots
