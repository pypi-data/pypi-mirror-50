    ...
    with maybe_show_progress(symbols, show_progress,
        ...
        for sid, symbol in enumerate(it):
            ...
            if norgatedata.subtype1(symbol) == "Index":
                ...
                #df['volume'] /= 1000 # Zipline tries to store volumes as UINT32 and index volumes typically exceed this by a lot.  We'll turn it into thousands

            # Zipline can't handle crazy volumes for stocks where there have been lots of splits
            # Turn adjusted volume data into max UINT32, as 
...
def _pricing_iter_futures(symbols, metadata, sessions, show_progress, start_session, end_session):
    with maybe_show_progress(symbols, show_progress,
        ...
        for sid, symbol in enumerate(it):
            ...
            if norgatedata.subtype1('$SPX') == "Index":
                df['volume'] = 0 # Zipline tries to store volumes as UINT32 and index volumes typically exceed this by a lot
