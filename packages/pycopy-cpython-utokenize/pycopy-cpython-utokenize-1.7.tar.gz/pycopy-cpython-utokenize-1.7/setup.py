...
setup(name='pycopy-cpython-utokenize',
      version='1.7',
      description='Pycopy module utokenize ported to CPython',
      ...
      license='Python',
      py_modules=['utokenize'],
      install_requires=['pycopy-cpython-ucollections'])
