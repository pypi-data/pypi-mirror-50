...
setup(
    ...
    keywords='tendril',
    url='https://github.com/tendril-framework/tendril-utils-gschem-files',
    project_urls={
        'Documentation': 'https://tendril-utils-gschem-files.readthedocs.io/en/latest',
        'Bug Tracker': 'https://github.com/tendril-framework/tendril-utils-gschem-files/issues',
        'Source Repository': 'https://github.com/tendril-framework/tendril-utils-gschem-files',
    },
