...
def variant_factory(variant_handle, owner=False):
    ...
    Returns:
        (UjoVariantBase): A variant wrapper class containing the handle
    """
...
class UjoList(UjoBase, collections.abc.MutableSequence):  # pylint: disable=too-many-ancestors
    ...
    def append(self, value):
        ...
        Args:
            value (UjoVariantBase): The Ujo variant to be added to the list

        Raises:
            TypeError: If objects other than objects derived from UjoVariantBase
                       are appended
        """
        if not isinstance(value, UjoBase):
            raise TypeError('Ujo list only accepts elements derived from '
                            'UjoVariantBase. Element is: {}'
    ...
    def count(self, value):
        ...
        Args:
            value (UjoVariantBase): The Ujo variant to count occurrences for
    ...
    def index(self, value, start=0, stop=None):
        ...
        Args:
            value (UjoVariantBase): The Ujo variant to return index for
    ...
    def __contains__(self, value):
        ...
        Args:
            value (UjoVariantBase): The Ujo variant to check membership of
    ...
    def __setitem__(self, index, value):
        ...
        Args:
            ...
            value (UjoVariantBase): an Ujo variant
        """
    ...
    def __getitem__(self, index):
        ...
        Returns:
            (UjoVariantBase): item from the list at index position
        """
        if index < 0:
            index += len(self)
        try:
    ...
    def get_variant(self, index, default=UjoNone, constraint=None):
        ...
        Args:
            index (int): item index
            default (UjoVariantBase): default fallback value
            constraint (class): class type as constraint for the list item

        Returns:
            (UjoVariantBase): item from the list at index position or default
        """
        if index < 0:
            index += len(self)
    ...
    def get_value(self, index, default=None, constraint=None):
        ...
        Returns:
            (UjoVariantBase): item value from the list at index position or default
        """
    ...
    def set_value(self, index, value, value_type):
        ...
        If the value is an instance of UjoVariantBase, the value_type is ignored.
    ...
    def as_pyobject(self) -> list:
        ...
        for item in self:
            if isinstance(item, UjoContainer):
                python_representation.append(item.as_pyobject())
            else:
                python_representation.append(item.value)
        return python_representation


class UjoMap(UjoBase, collections.abc.MutableMapping):  # pylint: disable=too-many-ancestors
    """ Class wrapper for Ujo Variant map
    ...
    def __iter__(self):
        ...
        Returns:
            (UjoVariantBase): keys of map as an instance of the Ujo Variant
        """
    ...
    def __setitem__(self, key, value):
        ...
        Args:
            key (UjoVariantBase): an Ujo variant instance
            value (UjoVariantBase): an Ujo variant instance
        """
    ...
    def __getitem__(self, key):
        ...
        Returns:
            (UjoVariantBase): item from the map by key
        """
        try:
    ...
    def get_variant(self, key, default=UjoNone, constraint=None,
        ...
        If the key is an instance of UjoVariantBase, the key_type is ignored.
        ...
        Returns:
            (UjoVariantBase): item from the map or default
        """
    ...
    def as_pyobject(self) -> dict:
        ...
        for key, value in self.items():
            if isinstance(value, UjoContainer):
                python_representation[key.value] = value.as_pyobject()
            else:
                python_representation[key.value] = value.value
        return python_representation
