...
class UpvestCLIConfig:
    ...
    def get_app_api(self):
        ...
        return UpvestTenancyAPI(key, secret, passphrase, self.base_url)
    ...
    def get_user_api(self):
        ...
        if username is None or password is None:
            print("Must set the user's --username [-l] and --password [-w]")
            sys.exit(1)

        return UpvestClienteleAPI(client_id, client_secret, username, password, self.base_url)
