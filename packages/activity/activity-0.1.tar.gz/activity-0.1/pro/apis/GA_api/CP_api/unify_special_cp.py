...
def unify_special_cp(product_List, cp, userInfo, productList_cp,kaiguan):
    """
    ...
    """
    if kaiguan == True:
        return un_special_cp(productList_cp, cp, userInfo, kaiguan)
    return un_special_cp(product_List, cp, userInfo, kaiguan)



def un_special_cp(productList, bean, userInfo, kaiguan):
