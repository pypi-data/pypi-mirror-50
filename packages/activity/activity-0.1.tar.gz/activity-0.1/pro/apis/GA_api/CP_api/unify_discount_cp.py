...
def unify_discount_cp(product_List, cp, userInfo, productList_cp, kaiguan):
    """
    ...
    """
    if kaiguan == True:
        return unify_dis_cp(productList_cp, cp, userInfo, kaiguan)
    return unify_dis_cp(product_List, cp, userInfo, kaiguan)


def unify_dis_cp(productList, bean, userInfo, kaiguan):
    """
