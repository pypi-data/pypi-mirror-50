...
class Armadillo(KaitaiStruct):
    ...
    class UiFrame(KaitaiStruct):
        ...
        def _read(self):
            ...
            self.data_payload = self._root.ArmadilloPayload(self._io, self, self._root)
    ...
    class ArmadilloPayload(KaitaiStruct):
        ...
        def _read(self):
            self.padding = self._io.read_bytes(146)
            self.rf_message = (self._io.read_bytes_term(0, False, True, True)).decode(u"ASCII")
