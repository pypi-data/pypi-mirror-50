...
parser.add_argument('-d', '--directory', '--dir', action='store', dest='d', help='Directory to file. Prefer cover to \" \" ')
args = parser.parse_args()
print(args)
uploader(directory=args.d, removeOldFiles=not args.cache, compairFiles=args.compare, excludedFiles=[])
