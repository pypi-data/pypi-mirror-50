...
class LightSet(controller.i_controller.LightSet):
    the_instance = None
    ...
    def get_color(self):
        ...
        return average_color(self.get_lifxlan().get_color_all_lights())
...
def configure(settings):
    LightSet.configure()
    lights = LightSet.get_instance()
    bind_instance(lights).to(controller.i_controller.LightSet)
    lights.discover()
