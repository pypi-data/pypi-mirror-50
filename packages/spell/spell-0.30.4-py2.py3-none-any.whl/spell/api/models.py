...
class Run(Model):
    ...
    compare_fields = ["id", "status", "command", "creator", "gpu", "git_commit_hash", "docker_image", "framework",
                      ...
                      "tensorboard_enabled", "tensorboard_directory", "tensorboard_parent_run_id", "distributed"]
    ...
    def __init__(self, id, status, command, creator, gpu, git_commit_hash, description, framework, docker_image,
                 ...
                 github_url=None, tensorboard_enabled=None, tensorboard_directory=None, tensorboard_parent_run_id=None,
                 distributed=None, labels=None, **kwargs):
        self.id = int(id)
        self.status = status
