...
@click.option("--stop-condition", multiple=True, help="Enter metric conditions to stop the run early")
@click.pass_context
...
def create_run_request(ctx, command, args, machine_type, pip_packages, requirements_file, apt_packages,
                       ...
                       tensorboard_dir=None, tensorboard_parent_run_id=None, stop_conditions=None, **kwargs):
