...
class sfs:
    ...
    def kfold_model_perm(self, X, y, params, folds = 5, model_name = 'logit', use_true_values = False, true_values = 'None'):
    ...
    def backwards_elimination(self, X, y, params, param_grid = 'None', model_name = 'logit', verbose = 0):
        ...
        for i in range(len(X.columns)):
            ...
            print(begin)
            df_perm, perm_df = self.kfold_model_perm(X[cols], y, params = params, model_name = model_name)
