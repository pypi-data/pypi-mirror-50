...
class TestAIOpenScaleClient(unittest.TestCase):
    ...
    def test_06_get_deployment(self):
        TestAIOpenScaleClient.model_uid = "11c49e24-7d67-4fb1-b4af-947b9463f45b"
        TestAIOpenScaleClient.deployment_uid = "373eecac-e1fd-4988-82f4-34a163cfcc03"
    ...
    def test_07_subscribe(self):
        subscription = TestAIOpenScaleClient.ai_client.data_mart.subscriptions.add(WatsonMachineLearningAsset(
            ...
            feature_columns=["ID", "CHURN", "Gender", "Status", "Children", "Est Income", "Car Owner", "Age",
                             "LongDistance", "International", "Local", "Dropped", "Paymethod", "LocalBilltype",
                             "LongDistanceBilltype", "Usage", "RatePlan"],
            categorical_columns=["ID", "CHURN", "Gender", "Status", "Children", "Car Owner", "Paymethod",
    ...
    def test_11_score(self):
        ...
        scoring_endpoint = "https://us-south.ml.cloud.ibm.com/v4/deployments/ff004fc4-cec7-4f2d-a6fb-1884054c3a1e/predictions"
        payload_scoring = {
            "input_data": [{
                "fields": ["ID", "CHURN", "Gender", "Status", "Children", "Est Income", "Car Owner", "Age",
                             "LongDistance", "International", "Local", "Dropped", "Paymethod", "LocalBilltype",
                             "LongDistanceBilltype", "Usage", "RatePlan"],
                "values": [
                    [23, "F", "M", "M", 2.000000, 20078.000000, "N", 32.846667, 9.650000, 0.000000, 6.330000, 0.000000,
