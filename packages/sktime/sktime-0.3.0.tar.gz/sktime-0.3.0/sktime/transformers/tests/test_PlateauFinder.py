...
def test_PlateauFinder(value):
    ...
    X = pd.DataFrame(pd.Series([
            ...
            pd.Series([0, value, value, value, value, value, 2, value]),  # nan at end
    ...
    expected_starts = [np.array([]), np.array([0]), np.array([1]), np.array([1, 6]), np.array([1]), np.array([1, 4])]
    expected_lengths = [np.array([]), np.array([2]), np.array([5]), np.array([2, 2]), np.array([3]), np.array([2, 2])]
