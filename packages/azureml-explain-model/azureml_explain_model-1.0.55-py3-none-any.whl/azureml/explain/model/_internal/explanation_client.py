...
class ExplanationClient(object):
    ...
    def upload_model_explanation(self,
        ...
        # upload initialization and evaluation datasets if available
        if init_dataset_id is None and hasattr(explanation, History.INIT_DATA):
            init_dataset_id = self._upload_dataset_to_service(explanation.init_data,
                                                              explanation,
                                                              'init_dataset.json',
                                                              '_init')
        ...
        if eval_dataset_id is None and hasattr(explanation, History.EVAL_DATA):
