...
def dbdata(host_dict):
    ...
    DB_D=['zlcommon','zlshenpi','zlsys','zljianzhu']
    ...
    for k in all_quyus.keys():
        ...
        for quyu in quyus:
            ...
            tmp=['zlsrc',quyu,'postgres','since2015',host_dict[k],db,schema,None,None,5,None,True,'normal',40,5,7,10,False,5,1,1,None,None,20,False,None]
            data.append(tmp)
