...
LOCAL_PACKAGE_DIRECTORY_NAMES = [
    ...
    'lib.commands',
    'lib.dataStructures',
    'lib.dataStructures.closest',
    'lib.dataStructures.contextChange',
    'lib.dataStructures.contextNetwork',
    'lib.dataStructures.cooccurrence',
    'lib.dataStructures.drift',
    'lib.dataStructures.frequency',
    'lib.dataStructures.sentiment',
    'lib.dataStructures.synonymNetwork',
    'lib.handlers',
    'lib.utils',
    'lib.wordSpaces'
]
