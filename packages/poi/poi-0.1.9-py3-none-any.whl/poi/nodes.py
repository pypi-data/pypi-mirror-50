...
class Box:
    ...
    def __init__(
        self, children: Iterable['Box'] = None, rowspan: int = None, colspan: int = None, offset: int = 0,
        grow: bool = False, **kwargs
    ):
        self.parent = None
...
ColumnDict = TypedDict('ColumnDict',
                       {'width': Optional[int], 'title': str, 'attr': Optional[str], 'render': Optional[Render]})
