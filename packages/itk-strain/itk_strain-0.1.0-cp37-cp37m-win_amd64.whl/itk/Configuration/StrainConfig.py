...
templates = (
  ...
  ('ImageToImageFilter', 'itk::ImageToImageFilter', 'itkImageToImageFilterID2ICVD22', False, 'itk::Image< double,2 >, itk::Image< itk::CovariantVector< double,2 >,2 >'),
  ...
  ('ImageToImageFilter', 'itk::ImageToImageFilter', 'itkImageToImageFilterID3ICVD33', False, 'itk::Image< double,3 >, itk::Image< itk::CovariantVector< double,3 >,3 >'),
