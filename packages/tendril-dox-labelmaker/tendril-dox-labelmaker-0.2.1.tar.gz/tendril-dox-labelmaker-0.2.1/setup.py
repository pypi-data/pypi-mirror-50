...
setup(
    ...
    keywords='tendril',
    url='https://github.com/tendril-framework/tendril-dox-labelmaker',
    project_urls={
        'Documentation': 'https://tendril-dox-labelmaker.readthedocs.io/en/latest',
        'Bug Tracker': 'https://github.com/tendril-dox-labelmaker/tendril-schema/issues',
        'Source Repository': 'https://github.com/tendril-framework/tendril-dox-labelmaker',
    },
