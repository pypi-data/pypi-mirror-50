...
from models.network_connection import NetworkConnection  # noqa: E501
...
class TestNetworkConnection(unittest.TestCase):
    ...
    def testNetworkConnection(self):
        ...
        # model = ibm_security_advisor_findings_api_client.models.network_connection.NetworkConnection()  # noqa: E501
        pass
