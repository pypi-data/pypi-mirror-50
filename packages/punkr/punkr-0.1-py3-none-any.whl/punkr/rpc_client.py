...
if __name__ == "__main__":
    message = str(JsonProtocol("1.0", "CommandProxy.HandleCommand", {"Line": "access foo"}))

    with RpcTcpClient("127.0.0.1", 7860) as client:
        print(client.send(message))

    async def test_send_message():
        async with RpcTcpClient("127.0.0.1", 7860) as client:
