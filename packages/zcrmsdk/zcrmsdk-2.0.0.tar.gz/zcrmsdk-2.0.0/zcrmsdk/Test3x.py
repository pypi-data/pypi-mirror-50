...
class MyClass(object):
    ...
    def search_records_by_email(self):
        try:
            ...
            resp=module_ins.search_records_by_email('email@zoho.com')
            print(resp.status_code)
            resp_info=resp.info
            print(resp_info.count)
            print(resp_info.page)
            ...
            for record_ins in record_ins_arr:
                ...
                print(record_ins.get_field_value('First_Name'))
                print(record_ins.field_data)
                print("\n\n")
        except ZCRMException as ex:
            print(ex.status_code)
    ...
    def search_records_by_phone(self):
        try:
            module_ins=ZCRMModule.get_instance('Leads')
            resp=module_ins.search_records_by_phone('9900000000')
            print(resp.status_code)
            resp_info=resp.info
            print(resp_info.count)
            print(resp_info.page)
    ...
    def search_records_by_criteria(self):
        try:
            module_ins=ZCRMModule.get_instance('Products')
            #resp=module_ins.search_records_by_criteria('((Last_Name:starts_with:Ls) and (Email:equals:sumanth.chilka@gmail.com))')
            resp=module_ins.search_records_by_criteria('((Product_Name:starts_with:pro) or (Product_Name:equals:Mango))') #search criteria
            print(resp.status_code)
            resp_info=resp.info
            print(resp_info.count)
            print(resp_info.page)
...
#refresh_token="1000.e6a2420454e6003f81237b3f4fa49313.22bf7b817a7d2238f9535b14b254e9cf"
#user_identifier="sumanth.chilka@zohocorp.com"
