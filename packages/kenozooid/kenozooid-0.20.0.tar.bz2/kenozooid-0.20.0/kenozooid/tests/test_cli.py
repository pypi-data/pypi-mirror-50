...
class NameParseTestCase(unittest.TestCase):
    ...
    def test_name(self):
        ...
        self.assertEqual('Tom', f)
        self.assertTrue(m is None)
        self.assertEqual('Cora', l)
    ...
    def test_name_middle(self):
        ...
        self.assertEqual('Thomas', f)
        self.assertEqual('Henry', m)
        self.assertEqual('Corra', l)
...
class UDDFInputActionTestCase(unittest.TestCase):
    ...
    def test_single(self):
        ...
        self.assertEqual(([None], ['f1']), args.input)
        self.assertEqual('out', args.output)
    ...
    def test_multiple(self):
        ...
        self.assertEqual(([None, None], ['f1', 'f2']), args.input)
        self.assertEqual('out', args.output)
    ...
    def test_opt_only(self):
        ...
        self.assertEqual((['2-3'], ['f1']), args.input)
        self.assertEqual('out', args.output)

        args = self.parser.parse_args(args=['-k', '2-3', 'f1', '-k', '3-4', 'f2', 'out'])
        self.assertEqual((['2-3', '3-4'], ['f1', 'f2']), args.input)
        self.assertEqual('out', args.output)
    ...
    def test_opt_first(self):
        ...
        self.assertEqual((['2-3', None], ['f1', 'f2']), args.input)
        self.assertEqual('out', args.output)
    ...
    def test_opt_last(self):
        ...
        self.assertEqual(([None, '2-3'], ['f2', 'f1']), args.input)
        self.assertEqual('out', args.output)
...
class CommandTestCase(unittest.TestCase):
    ...
    def test_simple_command(self):
        ...
        self.assertEqual('test', args.subcmd)
    ...
    def test_complex_command(self):
        ...
        self.assertTrue(hasattr(args, 'subcmd'))
        self.assertTrue(hasattr(args, 'parser'))
        self.assertEqual('test', args.cmd, args)
        ...
        self.assertTrue(hasattr(args, 'parser'))
        self.assertEqual('test', args.cmd, args)
        self.assertEqual('a', args.subcmd, args)
        ...
        self.assertTrue(hasattr(args, 'parser'))
        self.assertEqual('test', args.cmd, args)
        self.assertEqual('b', args.subcmd, args)
