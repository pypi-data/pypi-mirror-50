...
class SpecParserTestCase(unittest.TestCase):
    ...
    def test_multiple_sec(self):
        ...
        self.assertEqual(((14, 5), (15, 8)), result)
    ...
    def test_minutes(self):
        ...
        self.assertEqual(((14, 5), (315, 8)), result)
...
class InterpolationTestCase(unittest.TestCase):
    ...
    def test_descent(self):
        ...
        self.assertEqual(((0, 0), (1, 1), (2, 2)), tuple(result))

        spec = ((1, 1), (4, 4))
        result = interpolate(spec)
        self.assertEqual(((0, 0), (1, 1), (2, 2), (3, 3), (4, 4)), tuple(result))

        spec = ((2, 10),)
        result = interpolate(spec)
        self.assertEqual(((0, 0), (1, 5), (2, 10)), tuple(result))

        spec = ((2, 10), (15, 30))
        result = interpolate(spec)
        result = tuple(result)
        self.assertEqual((0, 0), result[0])
        self.assertEqual((3, 11), result[3])
        self.assertEqual((4, 13), result[4])
        self.assertEqual((13, 26), result[-3])
        self.assertEqual((14, 28), result[-2])
        self.assertEqual((15, 30), result[-1])
    ...
    def test_ascent(self):
        ...
        self.assertEqual(((3, 7), (4, 5)), result)

        spec = ((3, 15), (15, 10))
        result = tuple(interpolate(spec))[3:]
        self.assertEqual((3, 15), result[0])
        self.assertEqual((5, 14), result[1])
        self.assertEqual((12, 11), result[-2])
        self.assertEqual((15, 10), result[-1])
    ...
    def test_no_depth_change(self):
        ...
        spec = ((1, 15), (5, 15))
        result = interpolate(spec)
        self.assertEqual(((0, 0), (1, 15), (5, 15)), tuple(result))
    ...
    def test_slow_descent(self):
        ...
        spec = ((4, 1),)
        result = interpolate(spec)
        self.assertEqual(((0, 0), (4, 1)), tuple(result))

        spec = ((6, 2),)
        result = interpolate(spec)
        self.assertEqual(((0, 0), (3, 1), (6, 2)), tuple(result))

        spec = ((6, 3),)
        result = interpolate(spec)
        self.assertEqual(((0, 0), (2, 1), (4, 2), (6, 3)), tuple(result))
    ...
    def test_slow_ascent(self):
        ...
        spec = ((4, 1), (5, 0))
        result = interpolate(spec)
        self.assertEqual(((0, 0), (4, 1), (5, 0)), tuple(result))

        spec = ((6, 2), (10, 4))
        result = interpolate(spec)
        result = tuple(result)[2:]
        self.assertEqual(((6, 2), (8, 3), (10, 4)), result)

        spec = ((6, 2), (12, 4))
        result = interpolate(spec)
        result = tuple(result)[2:]
        self.assertEqual(((6, 2), (9, 3), (12, 4)), result)
