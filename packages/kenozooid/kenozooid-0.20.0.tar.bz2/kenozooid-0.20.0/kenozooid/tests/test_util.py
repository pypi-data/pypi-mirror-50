...
class PipeDataTestCase(unittest.TestCase):
    ...
    def test_pipe(self):
        ...
        self.assertEqual([2, 4, 6, 8], list(pipe(range(4), f1, f2)))
    ...
    def test_pipe_order(self):
        ...
        f2 = lambda it: (i * 2 for i in it)
        self.assertEqual([2, 4, 6, 8], list(pipe(range(4), f1, f2)))
        self.assertEqual([1, 3, 5, 7], list(pipe(range(4), f2, f1)))
...
class UtilsTestCase(unittest.TestCase):
    ...
    def test_nit(self):
        ...
        """
        it = (1, 2, 3, 4)
        self.assertEqual(it, nit(it))

        v = nit(None)
        self.assertEqual(list(), list(v))
    ...
    def test_format(self):
        ...
        """
        self.assertEqual('test ', nformat('{0} {1}', 'test', None))
        self.assertEqual('', nformat('{0}', None))
