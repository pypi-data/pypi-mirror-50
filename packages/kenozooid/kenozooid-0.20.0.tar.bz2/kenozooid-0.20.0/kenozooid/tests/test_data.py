...
class DivesTestCase(unittest.TestCase):
    ...
    def test_gas_basic(self):
        ...
        self.assertEqual(e, kd.gas(21, 0))

        e = kd.Gas(id='o2', name='O2', o2=100, he=0, depth=6)
        self.assertEqual(e, kd.gas(100, 0, depth=6))
