...
../venv/bin/python -m celery -A async_task --loglevel=info worker -b $REDIS_URL --result_backend xxx
...
def generate_celery(broker: str, result_backend: str = '', main: str = 'async_task', conf: str = 'async_task.conf'):
