...
from pysubway.service.booldata.multi_platforms_v2 import ApplyDetail
from pysubway.service.booldata.multi_platforms_v2 import LiabilitiesDetails
from pysubway.service.booldata.multi_platforms_v2 import OverdueDetail
from pysubway.service.booldata.multi_platforms_v2 import RepaymentDetail
from pysubway.service.booldata.multi_platforms_v2 import batch_test_apply_detail
from pysubway.service.booldata.multi_platforms_v2 import batch_test_liabilities_detail
from pysubway.service.booldata.multi_platforms_v2 import batch_test_overdue_detail
from pysubway.service.booldata.multi_platforms_v2 import batch_test_repayment_detail
from pysubway.utils.file import Dir
...
def batch_test_huizumodel(self: Any, account_info: Dict[str, str],
                          ...
                          ding_url: Optional[dingUrl] = None):
    """
    :param account_info:
    :param env:
    :param company_uuid:
...
@app.task(name='multi_v2_batch_test_overdue_detail', bind=True, autoretry_for=(RequestFailed,),
          retry_kwargs={'max_retries': 3})
def multi_v2_batch_test_overdue_detail(self, input: str,
                                       input_is_str: bool,
                                       account: Dict[str, str],
