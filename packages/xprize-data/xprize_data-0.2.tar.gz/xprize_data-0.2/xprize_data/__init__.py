...
def getDatasets(apiKey):
    ...
    resp = requests.request('POST', url='https://functions-pop.azurewebsites.net/api/blob-sas-token-generator?code=ogOXCDpGp5xCAHBezgaIUsHf2rWXM3k3PgOEO9VlxySb3U3WEpQztA==', json=payload,headers=headers)
