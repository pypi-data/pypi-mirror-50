...
class Execution(object):
    ...
    def __init__(self, id=None, name=None, version=None, kind=None, executable=None, start_time=None, end_time=None, status=None, input_artifacts=None, output_artifacts=None, configuration=None, annotations=None):  # noqa: E501
