...
class ProductListParser(object):
    ...
    def parse(self):
        ...
        next_page_url = next_page_url if next_page_url else self.parse_js_next_page_url()
        if next_page_url:
    ...
    def parse_js_next_page_url(self):
        ...
        return '{}?{}'.format(search_ajax_url, urlencode(search_query))
    ...
    def parse_js_products(self):
        ...
        products = []
        for item in run_params.get('items', []):
            try:
