...
class IntVarFilteredDecisionBuilder(DecisionBuilder):
    ...
    def BuildSolution(self) -> "bool":
        r""" Virtual method to redefine to build a solution."""
        return _pywrapcp.IntVarFilteredDecisionBuilder_BuildSolution(self)

    def number_of_decisions(self) -> "int64":
        r""" Returns statistics on search, number of decisions sent to filters, number of decisions rejected by filters."""
...
class RoutingFilteredDecisionBuilder(IntVarFilteredDecisionBuilder):
    r""" Filter-based decision builder dedicated to routing."""
    ...
    def MakeDisjunctionNodesUnperformed(self, node: 'int64') -> "void":
        r""" Make nodes in the same disjunction as 'node' unperformed. 'node' is a variable index corresponding to a node."""
    ...
    def MakeUnassignedNodesUnperformed(self) -> "void":
        r""" Make all unassigned nodes unperformed."""
...
class CheapestAdditionFilteredDecisionBuilder(RoutingFilteredDecisionBuilder):
    r""" Filtered-base decision builder based on the addition heuristic, extending a path from its start node with the cheapest arc."""
...
class EvaluatorCheapestAdditionFilteredDecisionBuilder(CheapestAdditionFilteredDecisionBuilder):
    r""" A CheapestAdditionFilteredDecisionBuilder where the notion of 'cheapest arc' comes from an arc evaluator."""
...
class ComparatorCheapestAdditionFilteredDecisionBuilder(CheapestAdditionFilteredDecisionBuilder):
    r""" A CheapestAdditionFilteredDecisionBuilder where the notion of 'cheapest arc' comes from an arc comparator."""
...
class ChristofidesFilteredDecisionBuilder(RoutingFilteredDecisionBuilder):
    r""" Christofides addition heuristic. Initially created to solve TSPs, extended to support any model by extending routes as much as possible following the path found by the heuristic, before starting a new route."""
