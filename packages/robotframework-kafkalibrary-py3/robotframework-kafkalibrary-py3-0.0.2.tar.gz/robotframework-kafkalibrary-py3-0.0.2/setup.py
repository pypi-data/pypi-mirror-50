...
exec(compile(open(join(dirname(__file__), 'KafkaLibrary', 'version.py'), "rb").read(), join(dirname(__file__), 'KafkaLibrary', 'version.py'), 'exec'))

DESCRIPTION = """
Kafka support for Robot Framework.
"""[1:-1]

setup(name         = 'robotframework-kafkalibrary-py3',
      version      = VERSION,
