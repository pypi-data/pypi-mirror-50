...
class Permission(node_models.Node):
    ...
    @classmethod
    def get(cls, uuid=None, codename=None, order_by=None, limit=None, skip=None, desc=False, only=None):
        """
...
class Group(node_models.Node):
    ...
    @classmethod
    def get(cls, uuid=None, name=None, order_by=None, limit=None, skip=None, desc=False, only=None):
        """
...
class User(node_models.Node):
    ...
    def create(cls, **extrafields):
        ...
        if settings.BULB_REGISTRATION_USE_EMAIL_CONFIRMATION:
            ...
            extrafields['email_confirmation_key'] = email_confirmation_key
            ...
            send_mail(
                from_email=settings.BULB_EMAIL_SENDER_NAME,
                subject=settings.BULB_EMAIL_SUBJECT,
                recipient_list=[f"{target_email}"],
                message=settings.BULB_EMAIL_DEFAULT_MESSAGE + confirmation_url,
                html_message=render_to_string(settings.BULB_EMAIL_TEMPLATE_PATH, {"confirmation_url": confirmation_url}))
