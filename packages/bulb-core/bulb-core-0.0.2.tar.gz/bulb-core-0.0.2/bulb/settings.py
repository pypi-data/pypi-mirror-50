...
def set_bulb_settings_on(root_settings):
    ...
    root_settings['BULB_LOGIN_URL'] = '/auth/login/'
    ...
    """
    root_settings['BULB_SFTP_SRC_STATICFILES_MODE'] = "both"
    ...
    root_settings['BULB_ADMIN_BASEPATH_NAME'] = "admin"

    # Format {"<application name>": {"printed_name": "xxx", "path_name": "xxx", "home_view_url_name": "xxx"}, ...}
