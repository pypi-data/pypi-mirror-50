...
4. To check if all works open the terminal, and go in your virtual environment if you have one. Then, run the python shell of your Django project and try to import the **bulb-core** package :
...
The **bulb-core package** is very fast to setup. Just **2 steps** are needed to execute yours first cypher requests.
...
```python
from bulb-core import set_bulb_settings_on
```
<br/>
<br/>
