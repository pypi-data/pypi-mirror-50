...
primme_source_files = [
   "primme/src/eigs/auxiliary_eigs.c",
   "primme/src/eigs/auxiliary_eigs_normal.c",
   "primme/src/eigs/convergence.c",
   "primme/src/eigs/correction.c",
   "primme/src/eigs/factorize.c",
   "primme/src/eigs/init.c",
   "primme/src/eigs/inner_solve.c",
   "primme/src/eigs/main_iter.c",
   "primme/src/eigs/ortho.c",
   "primme/src/eigs/primme_c.c",
   "primme/src/eigs/primme_f77.c",
   "primme/src/eigs/primme_interface.c",
   "primme/src/eigs/restart.c",
   "primme/src/eigs/solve_projection.c",
   "primme/src/eigs/update_projection.c",
   "primme/src/eigs/update_W.c",
   "primme/src/linalg/auxiliary.c",
   "primme/src/linalg/blaslapack.c",
   "primme/src/linalg/magma_wrapper.c",
   "primme/src/linalg/memman.c",
   "primme/src/linalg/wtime.c",
   "primme/src/svds/primme_svds_c.c",
   "primme/src/svds/primme_svds_f77.c",
   "primme/src/svds/primme_svds_interface.c"
]
...
def get_numpy_options():
   ...
   return dict(
                   ...
                   extra_compile_args = ["-DNDEBUG", "-DF77UNDERSCORE"]
   )
