...
from OmicsAnalysis.OmicsAnalysis.OmicsDataSet import OmicsDataSet
...
class DiscreteOmicsDataSet(OmicsDataSet):
    ...
    def batchSignificantGenePairs(self, dataset2=None, n_batches=1, testtype='right', count_thresh=20,
        ...
        pvals = batchDecorator(get_pval_two_mat, self.df, dataset2, n_batches=n_batches, testtype=testtype,
