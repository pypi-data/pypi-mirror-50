...
def est_cdc_t_bd(quyu):
    ...
    LOCATION ('pxf://192.168.4.183:51200/t_bd.t_bd_cdc_hunan_huaihua_gcjs?PROFILE=JDBC&JDBC_DRIVER=org.postgresql.Driver&DB_URL=jdbc:postgresql://192.168.4.201:5432/zlmine&USER=postgres&PASS=since2015')
...
def out_t_bd_pc_all(quyu):
    ...
    db_write(df,"t_bd_cdc_%s"%quyu,dbtype="postgresql",conp=['postgres','since2015','192.168.4.201','zlmine','t_bd']) 
