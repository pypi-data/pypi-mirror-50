...
def refine(file, pretrained_file = './data/ko_w2v_100d_min50_2nd_sg(news_tone)', refine_text = './data/total_labeled_article.csv', 
...
def split():
    ...
    # Embedding
    embedding = Word2Vec.load(('data/ko_w2v_100d_min50_2nd_sg'))
