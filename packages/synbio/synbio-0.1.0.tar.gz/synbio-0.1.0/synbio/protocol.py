...
class Protocol:
    ...
    def __init__(self, design: Design, name: str = ""):
        ...
        # map from each Instruction to the number of plates before it
        self.plate_count = 0
    ...
    def to_picklists(self, filename: str = "", platform: str = "tecan"):
        ...
        picklist_generators = {"tecan": to_tecan, "labcyte": to_labcyte}
    ...
    def add_instruction(self, instruction: Instruction):
        ...
        because I'm also counting the number of "pipette-able" plates after
        ...
        if instruction.transfers:
            ...
            if all(not isinstance(c, Fridge) for c in dest_containers):
                self.plate_count += len(Plates.from_instruction(instruction))
