...
class Transfer:
    ...
    def __init__(self, src, dest, volume: float = 0.0, instructions: List[str] = None):
        self.src = src
        self.dest = dest
        self.volume = volume
...
class Temperature:
    ...
    def __init__(
        self, temp: float = 27.0, time: float = 10.0, instructions: List[str] = None
    ):
        self.temp = temp
        self.time = time
        self.instructions = instructions
...
def _temp_instructions(temps: List[Temperature] = None) -> str:
    ...
    # create a high-level description of this thermo-cycle step
