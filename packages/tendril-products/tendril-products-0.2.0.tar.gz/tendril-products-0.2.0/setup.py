...
setup(
    ...
    description="Tendril Products Infrastructure",
    long_description='\n'.join([read('README.rst'), read('CHANGELOG.rst')]),
    long_description_content_type='text/x-rst',
    keywords='tendril',
    url='https://github.com/tendril-framework/tendril-products',
    project_urls={
        'Documentation': 'https://tendril-products.readthedocs.io/en/latest',
        'Bug Tracker': 'https://github.com/tendril-framework/tendril-products/issues',
        'Source Repository': 'https://github.com/tendril-framework/tendril-products',
    },
