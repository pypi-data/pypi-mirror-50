...
class FileDataSource:
    ...
    def datasource_from_str(path: str) -> 'FileDataSource':
        ...
        elif http_pattern.match(path):
            return HttpDataSource(path)
        else:
...
class HttpDataSource(FileDataSource):
    ...
    def __init__(self, path: Path):
        ...
        datasource_property = DataSourcePropertyValue(target=DatabaseAuthType.HTTP, resource_details=resource_details)
        super().__init__(datasource_property)
