...
class BaseInspector:
    def __init__(self,
        arguments: 'PropertyValues' = None,
        id: UUID = None,
        inspector_description: 'InspectorDescription' = None,
        property_descriptions: List['PropertyDescription'] = None,
        step_pinned_to: UUID = None,
        type: str = None,
    ):
        self._pod = {
            'arguments': to_dprep_pod(arguments),
            'id': to_dprep_pod(id),
            'inspectorDescription': to_dprep_pod(inspector_description),
            'propertyDescriptions': to_dprep_pod(property_descriptions),
            'stepPinnedTo': to_dprep_pod(step_pinned_to),
            'type': to_dprep_pod(type),
        }
    ...
    @property
    def inspector_description(self) -> 'InspectorDescription':
        return InspectorDescription.from_pod(self._pod['inspectorDescription']) if self._pod['inspectorDescription'] is not None else None

    @inspector_description.setter
    def inspector_description(self, value: 'InspectorDescription'):
        self._pod['inspectorDescription'] = to_dprep_pod(value)
    ...
    @property
    def step_pinned_to(self) -> UUID:
        return UUID(self._pod['stepPinnedTo']) if self._pod['stepPinnedTo'] is not None else None

    @step_pinned_to.setter
    def step_pinned_to(self, value: UUID):
        self._pod['stepPinnedTo'] = to_dprep_pod(value)
