...
class HTML2YAML(object):
    def __init__(self, args=None):
        ...
        self.parser = getattr(args, 'parser', None)
    ...
    def html_to_data(self, html):
        ...
        soup = bs4.BeautifulSoup(html, self.parser)
    ...
    def _strip(self, data):
        ...
        if not s[:first_nl_pos].strip():  # i.e. space until first newline
            ...
            # use data here, removing the final newline would get
            # your |- as marker
