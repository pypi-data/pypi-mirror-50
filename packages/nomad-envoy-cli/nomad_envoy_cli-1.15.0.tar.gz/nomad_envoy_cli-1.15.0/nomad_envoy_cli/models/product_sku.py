...
class ProductSku(object):
    ...
    def __init__(self, sku_number=None, price=None, rrp=None, group_buying_price=None, images=None, barcode=None, color=None, size=None, quantity=None, is_onsale=None, net_weight=None, gross_weight=None, shipping_cost=None, shipping_time=None):  # noqa: E501
