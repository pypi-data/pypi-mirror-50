...
setup(
    ...
    project_urls={
        'Documentation': 'https://tendril-conventions-series.readthedocs.io/en/latest',
        'Bug Tracker': 'https://github.com/tendril-framework/tendril-conventions-series/issues',
        'Source Repository': 'https://github.com/tendril-framework/tendril-conventions-series',
    },
