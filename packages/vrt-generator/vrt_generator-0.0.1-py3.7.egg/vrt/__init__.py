...
ALLOWED_LETTERS = "0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvqxyz_"


def check_letters(text):
    return min({l in ALLOWED_LETTERS for l in text})
