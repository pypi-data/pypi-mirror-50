...
def setup_db(app):
    ...
    get_or_create(db.session, MenuLink, title='Home', slug='home', url='/', can_edit=False)
    get_or_create(db.session, MenuLink, title='Sermons', slug='sermons', url='/sermons', can_edit=False)
    db.session.commit()
