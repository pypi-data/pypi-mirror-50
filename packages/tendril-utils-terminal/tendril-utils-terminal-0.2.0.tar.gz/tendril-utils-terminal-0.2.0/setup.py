...
setup(
    ...
    keywords='tendril',
    url='https://github.com/tendril-framework/tendril-utils-terminal',
    project_urls={
        'Documentation': 'https://tendril-utils-terminal.readthedocs.io/en/latest',
        'Bug Tracker': 'https://github.com/tendril-framework/tendril-utils-terminal/issues',
        'Source Repository': 'https://github.com/tendril-framework/tendril-utils-terminal',
    },
