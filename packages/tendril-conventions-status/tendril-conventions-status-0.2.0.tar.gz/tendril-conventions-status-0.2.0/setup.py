...
setup(
    ...
    keywords='tendril',
    url='https://github.com/tendril-framework/tendril-conventions-status',
    project_urls={
        'Documentation': 'https://tendril-conventions-status.readthedocs.io/en/latest',
        'Bug Tracker': 'https://github.com/tendril-framework/tendril-conventions-status/issues',
        'Source Repository': 'https://github.com/tendril-framework/tendril-conventions-status',
    },
