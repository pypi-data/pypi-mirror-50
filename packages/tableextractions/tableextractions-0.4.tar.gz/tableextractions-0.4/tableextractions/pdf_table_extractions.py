...
def extract_tables(pdf_name: str, table_coords: str, table_page: str, lattice_config:str, stream_config:str) -> list:
    """
    ...
    try:
        stream_params = json.load(open(stream_config))
        ...
        lattice_params = json.load(open(lattice_config))
