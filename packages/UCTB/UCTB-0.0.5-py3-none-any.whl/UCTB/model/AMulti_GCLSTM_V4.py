...
class AMulti_GCLSTM_V4(BaseModel):
    def __init__(self,
                 num_node,
                 external_dim,
                 closeness_len,
        ...
        super(AMulti_GCLSTM_V4, self).__init__(code_version=code_version, model_dir=model_dir, GPU_DEVICE=gpu_device)
    ...
    def build(self):
        ...
        super(AMulti_GCLSTM_V4, self).build()
