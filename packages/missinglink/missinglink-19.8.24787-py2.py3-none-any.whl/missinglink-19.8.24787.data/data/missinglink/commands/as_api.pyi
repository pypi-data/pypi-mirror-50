...
class Gcp:
	@staticmethod
	def init(org: str, project: str, region: Optional[str] = None, zone: Optional[str] = None, network: Optional[str] = None, queue: Optional[str] = None, credentials_file_path: Optional[str] = None) -> object: ...
