...
class Trainer(TrainerBase):
    def __init__(self,
        ...
        earlystopping_metric : str, optional (default=["-loss"])
        ...
        self._serialization_dir = os.path.join(serialization_dir, self.model.MODEL_NAME)
    ...
    def train(self) -> None:
        ...
        for epoch in mb:
            ...
            self._callbacks.write_tensorboard_logs(train_metrics, val_metrics, epoch + 1)
