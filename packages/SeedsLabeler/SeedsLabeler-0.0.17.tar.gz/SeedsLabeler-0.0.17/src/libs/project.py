...
class Project(object):
    ...
    def exportCSV(self):
        '''generates and saves CSV file will all verified images and statistics'''
        i = 0
        while os.path.exists(os.path.join(self.path, f"stats_{i}.csv")):
            i += 1  
        # counter_list = []
        df_list = []
        with open(os.path.join(self.path, f'stats_{i}.csv'),'w') as csvfile:
            ...
            print('written a file to ' + os.path.join(self.path, f'stats_{i}.csv' ))
