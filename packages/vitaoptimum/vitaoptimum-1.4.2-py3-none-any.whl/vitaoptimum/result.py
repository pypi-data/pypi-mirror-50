...
class _ResultBase:
    ...
    def plot_fobj_2d(self, title, range_x, range_y, logo=None, save_to=None):
        '''Plot 2d objective function within boundaries constraints'''
        plot.fobj_2d(self._fobj, title, range_x, range_y, logo, save_to)

    def plot_fobj_1d(self, title, range_x, logo=None, save_to=None):
        '''Plot 1d objective function within boundaries constraints'''
        plot.fobj_1d(self._fobj, title, range_x, logo, save_to)

    def plot_optimum_1d(self, title, eps, logo=None, save_to=None):
    ...
    def plot_optimum_2d(self, title, eps, logo=None, save_to=None):
        '''Plot found optimum for 1d objective function
           (point on fobj within a small area)'''
...
class _VitaOptimumResult(_ResultBase):
    ...
    def plot_convergence(self, title, logo=None):
