...
def convergence(convergence, title, logo, save_to=None):
...
def fobj_2d(fobj, title, range_x, range_y, logo, save_to=None):
...
def fobj_1d(fobj, title, range_x, logo, save_to=None):
