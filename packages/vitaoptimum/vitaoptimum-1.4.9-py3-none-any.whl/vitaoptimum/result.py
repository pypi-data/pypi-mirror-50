...
class _ResultBase:
    ...
    def plot_function(self, range=None, dim_indices=None,
        ...
        if self._dim == 1:
            ...
            if not isinstance(range, list):
                ...
                if not dim_indices:
                    dim_indices = [0, 1]
                low0  = range[0][dim_indices[0]]
                high0 = range[1][dim_indices[0]]
                low1  = range[0][dim_indices[1]]
                high1 = range[1][dim_indices[1]]
                if low0 == high0:
