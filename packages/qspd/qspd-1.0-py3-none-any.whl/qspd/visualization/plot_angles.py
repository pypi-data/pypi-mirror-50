...
def visualize(data, angle_indices=None, fourier=False, center_pi=False, epsilon=False,
    ...
    x_handle = "epsilon" if epsilon else "tau"
    for record in data:
...
def main():
    ...
    parser.add_argument("--epsilon", action="store_true",
                        help="Plot angles changing with respect to epsilon, rather than tau")
    ...
    visualize(data, angle_indices=args.angle_indices, fourier=args.fourier,
              center_pi=args.center_pi, epsilon=args.epsilon, light=args.light, transparent=args.transparent,
