/*
 * wq.app v1.2.0a1 - @wq/store 1.2.0-alpha.1
    ...
    _createClass(Store, [{
        ...
        value: function kvpReducer() {
            ...
            if (action.type === REMOVE) {
                ...
                state = _objectSpread({}, state, _defineProperty({}, action.payload.key, action.payload.value));
        ...
        value: function fetch(query, cache) {
            ...
            var data = _objectSpread({}, self.defaults, query);
