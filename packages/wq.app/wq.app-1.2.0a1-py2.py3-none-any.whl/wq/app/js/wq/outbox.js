/*
 * wq.app v1.2.0a1 - @wq/outbox 1.2.0-alpha.1
...
function () {
    function Outbox(store) {
        ...
        var _createOffline = reduxOffline.createOffline(_objectSpread({}, reduxOffline.offlineConfig, {
    ...
    _createClass(Outbox, [{
        ...
        value: function _enqueue(array, action, context) {
            ...
            var offlineAction = _objectSpread({}, action, {
                        ...
                        switch (_context2.prev = _context2.next) {
                            ...
                            case 3:
                                ...
                                if (csrftoken) {
                                    ...
                                    if (!options.json) {
                                        data = _objectSpread({}, data, _defineProperty({}, this.csrftokenField, csrftoken));
                                    }
                                }

                                defaults = _objectSpread({}, this.defaults);
        ...
        value: function _processBatchResponse(batchAction) {
            ...
            return batchAction.meta.actions.map(function (action, i) {
                ...
                if (resp && resp.status_code >= 200 && resp.status_code <= 299) {
                    ...
                    nextAction = _objectSpread({}, commit, {
                        payload: payload,
                        meta: _objectSpread({}, commit.meta, {
                            success: true
                        })
                    });
                } else {
                    ...
                    nextAction = _objectSpread({}, rollback, {
                        payload: error,
                        meta: _objectSpread({}, rollback.meta, {
                            success: false
                        })
                    });
                }
        ...
        value: function _dispatchBatchResponse(batchAction, dispatch) {
            this._processBatchResponse(batchAction).forEach(function (nextAction) {
                var action = _objectSpread({}, nextAction, {
                    meta: _objectSpread({}, nextAction.meta)
        ...
        value: function _updateParents(item, outboxId, resultId) {
            ...
            var data = _objectSpread({}, item.meta.offline.effect.data);
            ...
            return _objectSpread({}, item, {
                meta: _objectSpread({}, item.meta, {
                    offline: _objectSpread({}, item.meta.offline, {
                        effect: _objectSpread({}, item.meta.offline.effect, {
                            data: data
                        })
                    }),
        ...
        value: function () {
            ...
            _regeneratorRuntime.mark(function _callee5() {
                ...
                var pending, pendingById;
                return _regeneratorRuntime.wrap(function _callee5$(_context5) {
                    while (1) {
                        switch (_context5.prev = _context5.next) {
                            case 0:
                                if (Object.keys(_classPrivateFieldGet(this, _waiting)).length) {
                                    _context5.next = 2;
                                    break;
                                }
                            ...
                            case 4:
                                ...
                                Object.keys(_classPrivateFieldGet(this, _waiting)).forEach(function (id) {
        ...
        value: function () {
            ...
            /*#__PURE__*/
            _regeneratorRuntime.mark(function _callee11(itemId) {
                var item;
                    ...
                    while (1) {
                        switch (_context11.prev = _context11.next) {
                            ...
                            case 2:
                                ...
                                item = _context11.sent.list.find(_context11.t0);
                                _context11.next = 6;
                                return this._loadItemData(item);

                            case 6:
                                item = _context11.sent;
                                return _context11.abrupt("return", this._parseJsonForm(item));
        ...
        value: function () {
            ...
            /*#__PURE__*/
            _regeneratorRuntime.mark(function _callee12(item) {
                var setData;
                    ...
                    while (1) {
                        switch (_context12.prev = _context12.next) {
                            ...
                            case 5:
                                ...
                                return _context12.abrupt("return", setData(item, _classPrivateFieldGet(this, _memoryItems)[item.id]));

                            case 9:
                                return _context12.abrupt("return", this.store.lf.getItem('outbox_' + item.id).then(function (data) {
        ...
        value: function () {
            ...
            /*#__PURE__*/
            _regeneratorRuntime.mark(function _callee13(item) {
                var _this8 = this;
                    ...
                    while (1) {
                        switch (_context13.prev = _context13.next) {
                            ...
                            case 4:
                                ...
                                return _context13.abrupt("return", this._withoutData(item));

                            case 9:
                                return _context13.abrupt("return", this.store.lf.setItem('outbox_' + item.id, item.data).then(function () {
                ...
                return _regeneratorRuntime.wrap(function _callee14$(_context14) {
                    while (1) {
                        switch (_context14.prev = _context14.next) {
                            ...
                            case 3:
                                validItems = _context14.sent.list;
