/*
 * wq.app v1.2.0a1 - @wq/model 1.2.0-alpha.1
...
function (_ORM) {
    ...
    _createClass(ORMWithReducer, [{
                ...
                case OVERWRITE:
                    {
                        ...
                        session._modelmeta.upsert(_objectSpread({
                            id: cls.modelName
                        }, info));
        ...
        value: function _setNested(cls, data) {
            ...
            nested.forEach(function (_ref3) {
                ...
                item[relatedName].forEach(function (row) {
                    session[model].upsert(_objectSpread({}, row, _defineProperty({}, fkName, item.id)));
                });
        ...
        value: function _updateID(cls, oldId, newId) {
            ...
            cls.upsert(_objectSpread({}, exist.ref, {
                id: newId
            }));
            exist.delete();
        }
    ...
    _createClass(Model, [{
                ...
                return regenerator.wrap(function _callee2$(_context2) {
                    while (1) {
                        switch (_context2.prev = _context2.next) {
                            ...
                            case 2:
                                info = _context2.sent;
                                return _context2.abrupt("return", _objectSpread({}, info, {
        ...
        value: function () {
            ...
            regenerator.mark(function _callee8(filter, any, localOnly) {
                ...
                var result, qs, defaultFilter, customFilter, hasDefaultFilter, hasCustomFilter;
                    ...
                    while (1) {
                        switch (_context8.prev = _context8.next) {
                            case 0:
                                ...
                                _context8.next = 3;
                                return this.store.fetch(_objectSpread({
                                    url: this.config.url
                                }, filter));
                            ...
                            case 9:
                                ...
                                if (any) {
                                    ...
                                    qs = qs.filter(function (item) {
                                        return Object.keys(filter).filter(function (attr) {
                                            return _this7.matches(item, attr, filter[attr]);
                                        }).length > 0;
                                    });
                                } else {
                                    ...
                                    Object.keys(filter).forEach(function (attr) {
                                        ...
                                        if (_this7.isCustomFilter(attr, comp)) {
                                    ...
                                    if (hasCustomFilter) {
                                        qs = qs.filter(function (item) {
                                            ...
                                            Object.keys(customFilter).forEach(function (attr) {
                                                if (!_this7.matches(item, attr, customFilter[attr])) {
                                                    match = false;
                                                }
                                            });
                                            return match;
                                ...
                                return _context8.abrupt("return", this._processData(qs.toModelArray().map(function (instance) {
                                    return _this7._withNested(instance);
                                })));
                    ...
                    while (1) {
                        switch (_context15.prev = _context15.next) {
                            ...
                            case 2:
                                ...
                                q = _objectSpread({}, this.query, params);
                                _context15.next = 5;
