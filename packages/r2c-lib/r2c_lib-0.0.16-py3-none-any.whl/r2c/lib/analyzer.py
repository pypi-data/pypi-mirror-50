...
from r2c.lib.constants import DEFAULT_ANALYSIS_WORKING_TEMPDIR_SUFFIX, SPECIAL_ANALYZERS
...
class Analyzer:
    ...
    def _has_network_privileges(self, versioned_analyzer: VersionedAnalyzer) -> bool:
        analyzers_with_network_privileges = SPECIAL_ANALYZERS | {
            "r2c/typed-ast",
            "r2c/yarn-installer",
            "r2c/inactive",
        }
        return versioned_analyzer.name in analyzers_with_network_privileges
