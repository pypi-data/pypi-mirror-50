...
"""Add By hand at 2019/08/01 start"""
slice_role = Table('slice_role',
    metadata,
    Column("id", Integer, primary_key=True),
    Column('role_id', Integer, ForeignKey('ab_role.id')),
    Column('slices_id', Integer, ForeignKey('slices.id')),
    UniqueConstraint("role_id", "slices_id"))
"""Add By hand at 2019/08/01 start"""
...
class Slice(Model, AuditMixinNullable, ImportMixin):
    ...
    roles = relationship(security_manager.role_model, secondary=slice_role, backref='Slice', lazy=True) #Add By hand at 2019/08/01
...
"""Add By hand at 2019/08/01 start"""
dashboards_role = Table(
    'dashboards_role',
    metadata,
    Column("id", Integer, primary_key=True),
    Column('role_id', Integer, ForeignKey('ab_role.id')),
    Column('dashboards_id', Integer, ForeignKey('dashboards.id')),
    UniqueConstraint("role_id", "dashboards_id"))
"""Add By hand at 2019/08/01 end"""
...
class Dashboard(Model, AuditMixinNullable, ImportMixin):
    ...
    roles = relationship(security_manager.role_model, secondary=dashboards_role, backref='Dashboard', lazy=True) #Add By hand at 2019/08/01
