...
from xyscript.source.html import diagnosemail_body, diagnosemail_header
...
class Email():
    ...
    def send_diagnose(self,git_objc=None):
        ...
        # mail = diagnosemail_body.replace('\n','')
        # print(mail)
        
        content_string = diagnosemail_body.format(project_url='test',project_name='test',user_name='test',branch_name='test',commit_content='test',commit_url='test',commit_id='test',date='test',result='test',result_detail='test')
