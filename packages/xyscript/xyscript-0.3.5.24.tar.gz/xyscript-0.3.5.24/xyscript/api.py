...
-u $branch_url  -c $CI_COMMIT_MESSAGE -a $commit_url -d $CI_COMMIT_SHA

    # git_objc['project_url'] = 'test'    branch_url	
    # git_objc['branch_name'] = 'test'    CI_COMMIT_REF_NAME
    # git_objc['commit_content'] = 'test' CI_COMMIT_MESSAGE
    # git_objc['commit_url'] = 'test'     commit_url
    # git_objc['commit_id'] = 'test'      CI_COMMIT_SHA	
...
def diagnose(*parameters):
    ...
    诊断
    """
    global PROJECT_BRANCH,PROJECT_ADDRESS,DEV_BRANCH,PROJECT_BUILD,TAG_NAME
    # git_objc['project_url'] = 'test'
    # git_objc['branch_name'] = 'test'
    # git_objc['commit_content'] = 'test'
    # git_objc['commit_url'] = 'test'
    # git_objc['commit_id'] = 'test'
    # git_objc['result'] = 'test'
    # git_objc['result_detail'] = 'test'

    # -t $branch_url  -d $CI_COMMIT_SHA

    git_objc = {}
    git_objc['project_url'] = TAG_NAME 	
    git_objc['branch_name'] = PROJECT_BRANCH 
    git_objc['commit_content'] = DEV_BRANCH 
