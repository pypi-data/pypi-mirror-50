...
from astar_wxsdk.utils import timezone
from astar_wxsdk.pay.utils import get_external_ip
from astar_wxsdk.pay.base import BaseWxPayAPI
from astar_wxsdk.utils import to_text, json
from astartool.random import random_string
from astar_wxsdk.pay.utils import calculate_signature


class WxOrder(BaseWxPayAPI):
    ...
    def create(self, trade_type, body, total_fee, notify_url, client_ip=None,
        ...
        data.update(kwargs)
        return self._post('pay/unifiedorder', data=data, verify=self.verify)
    ...
    def query(self, transaction_id=None, out_trade_no=None):
        ...
        return self._post('pay/orderquery', data=data, verify=self.verify)
    ...
    def close(self, out_trade_no):
        ...
        return self._post('pay/closeorder', data=data, verify=self.verify)
    ...
    def reverse(self, transaction_id=None, out_trade_no=None):
        ...
        return self._post('secapi/pay/reverse', data=data, verify=self.verify)
