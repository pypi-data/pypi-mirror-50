...
class WxTools(BaseWxPayAPI):
    ...
    def short_url(self, long_url):
        ...
        return self._post('tools/shorturl', data=data, verify=self.verify)
    ...
    def download_bill(self, bill_date, bill_type='ALL', device_info=None):
        ...
        return self._post('pay/downloadbill', data=data, verify=self.verify)

    def download_fundflow(self, bill_date, account_type='Basic',
                          tar_type=None, *, sign_type='HMAC-SHA256'):
        """
        下载资金账单
        ...
        return self._post('pay/downloadfundflow', data=data, verify=self.verify)
    ...
    def auto_code_to_openid(self, auth_code):
        ...
        return self._post('tools/authcodetoopenid', data=data, verify=self.verify)
