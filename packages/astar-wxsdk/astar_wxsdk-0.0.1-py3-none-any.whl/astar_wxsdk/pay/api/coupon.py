...
class WxCoupon(BaseWxPayAPI):
    ...
    def send(self, user_id, stock_id, op_user_id=None, device_info=None,
        ...
        return self._post('mmpaymkttransfers/send_coupon', data=data, verify=self.verify)
    ...
    def query_coupon(self, coupon_id, user_id,
        ...
        return self._post('promotion/query_coupon', data=data, verify=self.verify)
