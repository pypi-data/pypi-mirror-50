...
class WxRefund(BaseWxPayAPI):
    ...
    def apply(self, total_fee, refund_fee, out_refund_no, transaction_id=None,
        ...
        return self._post('secapi/pay/refund', data=data, verify=self.verify)
    ...
    def query(self, refund_id=None, out_refund_no=None, transaction_id=None,
        ...
        return self._post('pay/refundquery', data=data, verify=self.verify)
