...
class WxRedpack(BaseWxPayAPI):
    ...
    def send_group(self, user_id, total_amount, send_name, act_name, wishing,
        ...
        return self._post('mmpaymkttransfers/sendgroupredpack', data=data,verify=self.verify)
    ...
    def query(self, out_trade_no, bill_type='MCHT'):
        ...
        return self._post('mmpaymkttransfers/gethbinfo', data=data, verify=self.verify)
