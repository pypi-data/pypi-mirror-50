...
from astar_wxsdk.pay.utils import get_external_ip, rsa_encrypt
from astar_wxsdk.pay.base import BaseWxPayAPI


class WxTransfer(BaseWxPayAPI):
    ...
    def transfer(self, user_id, amount, desc, client_ip=None,
        ...
        return self._post('mmpaymkttransfers/promotion/transfers', data=data, verify=self.verify)
    ...
    def query(self, out_trade_no):
        ...
        return self._post('mmpaymkttransfers/gettransferinfo', data=data, verify=self.verify)
    ...
    def transfer_bankcard(self, true_name, bank_card_no, bank_code, amount, desc=None, out_trade_no=None):
        ...
        return self._post('mmpaysptrans/pay_bank', data=data, verify=self.verify)
    ...
    def query_bankcard(self, out_trade_no):
        ...
        return self._post('mmpaysptrans/query_bank', data=data, verify=self.verify)
    ...
    def get_rsa_public_key(self):
        ...
        return self._post('https://fraud.mch.weixin.qq.com/risk/getpublickey', data=data, verify=self.verify)
