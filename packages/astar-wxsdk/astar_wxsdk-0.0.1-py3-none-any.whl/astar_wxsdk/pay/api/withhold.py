...
from astar_wxsdk.pay.utils import get_external_ip, calculate_signature
from astar_wxsdk.pay.base import BaseWxPayAPI


class WxWithhold(BaseWxPayAPI):
    ...
    def query_signing(self, contract_id=None, plan_id=None, contract_code=None, openid=None, version="1.0"):
        ...
        return self._post('papay/querycontract', data=data, verify=self.verify)
    ...
    def apply_deduct(self, body, total_fee, contract_id, notify_url, out_trade_no=None,
        ...
        return self._post("pay/pappayapply", data=data, verify=self.verify)
    ...
    def query_order(self, transaction_id=None, out_trade_no=None):
        ...
        return self._post("pay/paporderquery", data=data, verify=self.verify)
    ...
    def apply_cancel_signing(self, contract_id=None, plan_id=None, contract_code=None,
        ...
        return self._post("papay/deletecontract", data=data, verify=self.verify)
