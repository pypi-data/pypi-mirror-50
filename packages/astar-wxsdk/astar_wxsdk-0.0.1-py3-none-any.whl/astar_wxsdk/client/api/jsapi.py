...
class WxJSAPI(BaseWxAPI):
    ...
    def get_jsapi_ticket(self):
        ...
        :return: ticket
        """
        ticket_key = '{0}_jsapi_ticket'.format(self.app_id)
        expires_at_key = '{0}_jsapi_ticket_expires_at'.format(self.app_id)
    ...
    def get_jsapi_card_params(self, card_ticket, card_type, **kwargs):
        ...
        card_signature_dict = {
            'card_type': card_type,
            'noncestr': kwargs.get('noncestr', random_string(16)),
