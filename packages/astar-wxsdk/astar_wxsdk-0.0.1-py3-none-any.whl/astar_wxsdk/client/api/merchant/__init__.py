...
from astar_wxsdk.client.api.merchant.category import MerchantCategory
from astar_wxsdk.client.api.merchant.stock import MerchantStock
from astar_wxsdk.client.api.merchant.express import MerchantExpress
from astar_wxsdk.client.api.merchant.group import MerchantGroup
from astar_wxsdk.client.api.merchant.shelf import MerchantShelf
from astar_wxsdk.client.api.merchant.order import MerchantOrder
from astar_wxsdk.client.api.merchant.common import MerchantCommon


class WxMerchant(BaseWxAPI):
    API_BASE_URL = 'https://api.weixin.qq.com/'

    def __init__(self, *args, **kwargs):
        super(WxMerchant, self).__init__(*args, **kwargs)
