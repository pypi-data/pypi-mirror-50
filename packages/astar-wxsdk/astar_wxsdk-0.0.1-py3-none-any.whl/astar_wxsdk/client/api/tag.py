...
from astar_wxsdk.utils import to_text
from astar_wxsdk.client.api.base import BaseWxAPI


class WxTag(BaseWxAPI):
    ...
    def tag_user(self, tag_id, user_id):
        ...
        if isinstance(user_id, (tuple, list)):
            ...
            data['openid_list'] = [user_id, ]
        return self._post('tags/members/batchtagging', data=data, verify=self.verify)
    ...
    def untag_user(self, tag_id, user_id):
        ...
        if isinstance(user_id, (tuple, list)):
            ...
            data['openid_list'] = [user_id, ]
        return self._post('tags/members/batchuntagging', data=data, verify=self.verify)
    ...
    def iter_tag_users(self, tag_id, first_user_id=None):
        ...
        while True:
            ...
            for openid in follower_data['data']['openid']:
                yield openid
            first_user_id = follower_data.get('next_openid', None)
