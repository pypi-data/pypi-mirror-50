...
from astar_wxsdk.exceptions import WxClientException
from astar_wxsdk.client.api.base import BaseWxAPI


class WxMenu(BaseWxAPI):
    ...
    def delete(self):
        ...
        """
        return self._get('menu/delete', verify=self.verify)
    ...
    def get_menu_info(self):
        ...
        """
        return self._get('get_current_selfmenu_info', verify=self.verify)
