...
class WxScan(BaseWxAPI):
    ...
    def get_merchant_info(self):
        ...
        """
        return self._get('merchantinfo/get', verify=self.verify)
    ...
    def create_product(self, product_data):
        ...
        :return: 返回的 JSON 数据包
        """
        return self._post('product/create', data=product_data, verify=self.verify)
    ...
    def modify_product_status(self, standard, key, status):
        ...
        return self._post('product/modstatus', data=data, verify=self.verify)
    ...
    def set_test_whitelist(self, userids=None, usernames=None):
        ...
        return self._post('testwhitelist/set', data=data, verify=self.verify)
    ...
    def get_product(self, standard, key):
        ...
        return self._post('product/get', data=data, verify=self.verify)
    ...
    def list_product(self, offset=0, limit=10, status=None, key=None):
        ...
        return self._post('product/getlist', data=data, verify=self.verify)
    ...
    def update_product(self, product_data):
        ...
        :return: 返回的 JSON 数据包
        """
        return self._post('product/update', data=product_data, verify=self.verify)
    ...
    def clear_product(self, standard, key):
        ...
        return self._post('product/clear', data=data, verify=self.verify)
    ...
    def check_ticket(self, ticket):
        ...
        :return: 返回的 JSON 数据包
        """
        return self._post('scanticket/check', data={'ticket': ticket}, verify=self.verify)
