...
from astar_wxsdk.common import WxErrorCode
from astar_wxsdk.utils import json, get_querystring
from astar_wxsdk.session.memorystorage import MemoryStorage
from astar_wxsdk.exceptions import WxClientException, APILimitedException
...
def _is_api_endpoint(obj):
    return isinstance(obj, BaseWxAPI)


class BaseWxClient(Account):
    API_BASE_URL = ''

    def __new__(cls, *args, **kwargs):
        self = super(BaseWxClient, cls).__new__(cls)
    ...
    def __init__(self,
                 ...
                 *,
                 app_secret=None):
        super(BaseWxClient, self).__init__(
                app_id, app_secret
        )
        ...
        if isinstance(session, six.string_types):
            ...
            prefix = querystring.get('prefix', ['astarwxsdk'])[0]
    ...
    def _fetch_access_token(self, url, params, verify=False):
