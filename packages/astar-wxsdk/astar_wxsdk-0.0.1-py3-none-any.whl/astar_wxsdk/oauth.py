...
from astar_wxsdk.exceptions import WxOAuthException
from astar_wxsdk.utils import json
from snowland_authsdk.login import Account

class WxOAuth(Account):
    """ 微信公众平台 OAuth 网页授权
    ...
    def __init__(self, app_id, secret, redirect_uri, scope='snsapi_base', state='', verify=False):
        """
        ...
        """
        super(WxOAuth, self).__init__(app_id, secret)
