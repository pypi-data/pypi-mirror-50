...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'azure', 'v0.19.5-dev.1565338731+g7bc0b2d0'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource azure v0.19.5-dev.1565338731+g7bc0b2d0`
                """)
            else:
                raise
