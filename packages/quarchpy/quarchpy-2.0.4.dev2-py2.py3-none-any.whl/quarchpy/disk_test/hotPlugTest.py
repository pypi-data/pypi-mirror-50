...
def simpleHotPlugTest (uniqueID, quarchName, driveName, insertTime, repeats=1, onTime=10, offTime=5):
    ...
    # Log start of test
    sendLogMessage (time.time(), "testDescription", "Starting Hotplug test at: " + str(insertTime) + "mS on device: " + driveName + ", over " + str(repeats) + " repetitions", os.path.basename(__file__) + " - " + sys._getframe().f_code.co_name, uId = uniqueID + "." + str(counter));
...
def incrementID (counter, uniqueID):
    counter = counter + 1
