...
def ActivateRemoteServer(portNumber=9742, localHost=True):
    ...
    for item, key in driveTestConfig.testCallbacks.items():
        print (item)
            ...
            while continueScript:
                ...
                try:
                    ...
                    if myobj.moduleName == "driveTestCore":
                        ...
                        modulePointer = importlib.import_module("." + myobj.moduleName, "quarchpy.disk_test")  # sys.modules[myobj.moduleName]
