...
class NodeVisitor(parsimonious.NodeVisitor):
    ...
    def parse(self, type_str):
        ...
        :class:`~vips_abi.grammar.ABIType`.  If a type string cannot be parsed,
        throws :class:`~vips_abi.exceptions.ParseError`.

        :param type_str: The type string to be parsed.
        :returns: An instance of :class:`~vips_abi.grammar.ABIType` containing
...
class ABIType:
    ...
    def item_type(self):
        ...
        :class:`~vips_abi.grammar.ABIType` instance for the array's items.
        """
    ...
    def validate(self):  # pragma: no cover
        ...
        Raises :class:`~vips_abi.exceptions.ABITypeError` if validation fails.
        """
...
class TupleType(ABIType):
    ...
    def __init__(self, components, arrlist=None, *, node=None):
        ...
        """
        A tuple of :class:`~vips_abi.grammar.ABIType` instances for each of the
