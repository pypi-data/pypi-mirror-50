...
class DeviceProperties(object):
    ...
    def get_all_properties(self):
        return {
            property_type.PACKAGE_NAME.name: self.rox_options.version,
            property_type.VERSION_NAME.name: self.rox_options.version,
            property_type.LIB_VERSION.name: self.lib_version,
            property_type.ROLLOUT_BUILD.name: '50',
            property_type.API_VERSION.name: Build.API_VERSION,
            property_type.APP_VERSION.name: self.rox_options.version,
            property_type.APP_RELEASE.name: self.rox_options.version,
