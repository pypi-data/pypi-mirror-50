...
class Rox:
    ...
    def setup(api_key, rox_options=None):
        try:
            ...
            Rox.core.add_custom_property_if_not_exists(DeviceProperty(property_type.PLATFORM.name, CustomPropertyType.STRING, server_properties.get_all_properties()[property_type.PLATFORM.name]))
            Rox.core.add_custom_property_if_not_exists(DeviceProperty(property_type.APP_RELEASE.name, CustomPropertyType.SEMVER, server_properties.get_all_properties()[property_type.APP_RELEASE.name]))
            ...
            Rox.core.add_custom_property_if_not_exists(DeviceProperty('internal.realPlatform', CustomPropertyType.STRING, server_properties.get_all_properties()[property_type.PLATFORM.name]))
            Rox.core.add_custom_property_if_not_exists(DeviceProperty('internal.customPlatform', CustomPropertyType.STRING, server_properties.get_all_properties()[property_type.PLATFORM.name]))
            ...
            setup_task = Rox.core.setup(sdk_settings, server_properties, rox_options)
