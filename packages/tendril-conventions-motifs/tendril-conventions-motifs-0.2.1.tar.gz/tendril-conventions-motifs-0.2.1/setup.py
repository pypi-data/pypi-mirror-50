...
setup(
    ...
    keywords='tendril',
    url='https://github.com/tendril-framework/tendril-conventions-motifs',
    project_urls={
        'Documentation': 'https://tendril-conventions-motifs.readthedocs.io/en/latest',
        'Bug Tracker': 'https://github.com/tendril-framework/tendril-conventions-motifs/issues',
        'Source Repository': 'https://github.com/tendril-framework/tendril-conventions-motifs',
    },
