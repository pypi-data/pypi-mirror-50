...
validatorWithFilledAndUniqueStoreNumbers = StoreNumberColumnValidator(dataWithFilledAndUniqueStoreNumbers, True)
validatorWithPartiallyFilledStoreNumbers = StoreNumberColumnValidator(dataWithPartiallyFilledStoreNumbers, True)
validatorWithDuplicateStoreNumbers = StoreNumberColumnValidator(dataWithDuplicateStoreNumbers, True)
validatorWithAllNullStoreNumbers = StoreNumberColumnValidator(dataWithAllNullStoreNumbers, True)
