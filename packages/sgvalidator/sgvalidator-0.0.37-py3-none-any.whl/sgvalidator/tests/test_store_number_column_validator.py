...
validatorWithFilledAndUniqueStoreNumbers = StoreNumberColumnValidator(dataWithFilledAndUniqueStoreNumbers, False)
validatorWithPartiallyFilledStoreNumbers = StoreNumberColumnValidator(dataWithPartiallyFilledStoreNumbers, False)
validatorWithDuplicateStoreNumbers = StoreNumberColumnValidator(dataWithDuplicateStoreNumbers, False)
validatorWithAllNullStoreNumbers = StoreNumberColumnValidator(dataWithAllNullStoreNumbers, False)
...
class TestStoreNumberColumnValidator(TestCase):
    ...
    def testValidate(self):
        ...
        with self.assertRaises(AssertionError):
            validatorWithPartiallyFilledStoreNumbers.validate()
            validatorWithDuplicateStoreNumbers.validate()
