...
class ValidatorRunner:
    def __init__(self, data, debug, classesToIgnore):
        ...
        self.validators = [
            ...
            FillRateValidator(self.data, self.debug, classesToIgnore=classesToIgnore),
            ...
            CountryValidator(self.data, self.debug, classesToIgnore=classesToIgnore),
            TrashValueValidator(self.data, self.debug, classesToIgnore=classesToIgnore),
            CountValidator(self.data, self.debug, classesToIgnore=classesToIgnore),
            StoreNumberColumnValidator(self.data, self.debug, classesToIgnore=classesToIgnore),
            StreetAddressValidator(self.data, self.debug, classesToIgnore=classesToIgnore),
            GeoConsistencyValidator(self.data, self.debug, classesToIgnore=classesToIgnore)
        ]
