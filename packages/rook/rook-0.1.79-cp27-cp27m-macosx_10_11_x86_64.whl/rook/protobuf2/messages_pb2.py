...
_USAGEUPDATEMESSAGE = _descriptor.Descriptor(
  name='UsageUpdateMessage',
  full_name='com.rookout.UsageUpdateMessage',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='aug_id', full_name='com.rookout.UsageUpdateMessage.aug_id', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='hitCountInformation', full_name='com.rookout.UsageUpdateMessage.hitCountInformation', index=1,
...
_USAGEUPDATEMESSAGE.fields_by_name['hitCountInformation'].message_type = _AGENTIDHITCOUNTPAIR
...
DESCRIPTOR.message_types_by_name['UsageUpdateMessage'] = _USAGEUPDATEMESSAGE
...
UsageUpdateMessage = _reflection.GeneratedProtocolMessageType('UsageUpdateMessage', (_message.Message,), dict(
  DESCRIPTOR = _USAGEUPDATEMESSAGE,
  __module__ = 'messages_pb2'
  # @@protoc_insertion_point(class_scope:com.rookout.UsageUpdateMessage)
  ))
_sym_db.RegisterMessage(UsageUpdateMessage)
