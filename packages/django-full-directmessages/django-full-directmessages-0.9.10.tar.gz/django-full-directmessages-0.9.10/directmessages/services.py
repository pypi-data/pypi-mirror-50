...
class MessagingService(object):
    ...
    def send_message(self, sender, recipient, message, quote_id):
        """
        Send a new message
        :param sender: user
        ...
        message = Message(sender=sender, recipient=recipient, content=str(message), title=quote_id)
        message.save()
    ...
    def get_conversation(self, user1, user2, quote_id, limit=None, reversed=False, mark_read=False):
        """
