...
* Support for Microsoft Azure ML Service deployments
* Updated the built-in sample Golf model
* Generation of the explanation for one live scoring prediction added to the execution scenario
...
usage: ibm-ai-openscale-cli [-h] (-a APIKEY | -i IAM_TOKEN)
                            ...
                            [--model {all,GermanCreditRiskModel,
                                      DrugSelectionModel,GolfModel}]
