...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'gcp', 'v0.18.16-dev.1565046969+g784d5f5'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource gcp v0.18.16-dev.1565046969+g784d5f5`
                """)
            else:
                raise
