...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'gcp', 'v0.18.16-dev.1565336889+gf890e33'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource gcp v0.18.16-dev.1565336889+gf890e33`
                """)
            else:
                raise
