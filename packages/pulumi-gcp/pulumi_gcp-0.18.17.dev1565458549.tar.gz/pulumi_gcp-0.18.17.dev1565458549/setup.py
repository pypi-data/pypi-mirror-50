...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'gcp', 'v0.18.17-dev.1565458549+g2751b1d'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource gcp v0.18.17-dev.1565458549+g2751b1d`
                """)
            else:
                raise
